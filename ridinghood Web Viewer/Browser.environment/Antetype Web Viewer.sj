@STATIC;1.0;p;15;AppController.jt;17401;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;11;GDProject.ji;11;GDLibrary.ji;15;GDLookAndFeel.ji;7;NSSet.ji;9;NSArray.ji;10;GDScreen.ji;10;GDWidget.ji;10;GDCanvas.ji;17;GDImageResource.ji;12;CTGradient.ji;17;NSMutableString.ji;21;NSMutableDictionary.ji;29;GDNonBlockingOperationQueue.ji;23;GDScreenChangeManager.jt;17063;
...
}),new objj_method(sel_getUid("layoutPolicy"),function(_94,_95){
with(_94){
return layoutPolicy;
}
}),new objj_method(sel_getUid("setLayoutPolicy:"),function(_96,_97,_98){
with(_96){
if(objj_msgSend(layoutPolicy,"layoutPolicyCode")==objj_msgSend(_98,"layoutPolicyCode")){
return;
}
objj_msgSend(layoutPolicy,"release");
layoutPolicy=objj_msgSend(_98,"retain");
objj_msgSend(screenChangeManager,"renderObjectNeedsHorizontalCellLayout:",_96);
objj_msgSend(screenChangeManager,"renderObjectNeedsVerticalCellLayout:",_96);
}
}),new objj_method(sel_getUid("layoutPolicyCode"),function(_99,_9a){
with(_99){
return objj_msgSend(layoutPolicy,"layoutPolicyCode");
}
}),new objj_method(sel_getUid("setLayoutPolicyCode:"),function(_9b,_9c,_9d){
with(_9b){
objj_msgSend(_9b,"setLayoutPolicy:",objj_msgSend(GDLayoutPolicy,"layoutPolicyWithCode:",_9d));
}
}),new objj_method(sel_getUid("affineTransform"),function(_9e,_9f){
with(_9e){
var _a0=objj_msgSend(_9e,"affineOriginTransform");
objj_msgSend(_a0,"appendTransform:",objj_msgSend(_9e,"affineBorderTransform"));
return _a0;
}
}),new objj_method(sel_getUid("affineBorderTransform"),function(_a1,_a2){
with(_a1){
var _a3=objj_msgSend(GDAffineTransform,"transform");
objj_msgSend(_a3,"translateXBy:yBy:",objj_msgSend(_a1,"borderLeftWidth"),objj_msgSend(_a1,"borderTopWidth"));
return _a3;
}
}),new objj_method(sel_getUid("updateCornerPoints"),function(_a4,_a5){
with(_a4){
}
}),new objj_method(sel_getUid("setBounds:"),function(_a6,_a7,_a8){
with(_a6){
_a8.origin.x=floorf(_a8.origin.x);
_a8.origin.y=floorf(_a8.origin.y);
_a8.size.width=floorf(_a8.size.width);
if(objj_msgSend(_a6,"minimumWidth")!=0&&_a8.size.width<objj_msgSend(_a6,"minimumWidth")){
_a8.size.width=objj_msgSend(_a6,"minimumWidth");
}
if(objj_msgSend(_a6,"maximumWidth")!=0&&_a8.size.width>objj_msgSend(_a6,"maximumWidth")){
_a8.size.width=objj_msgSend(_a6,"maximumWidth");
}
if(objj_msgSend(_a6,"minimumHeight")!=0&&_a8.size.height<objj_msgSend(_a6,"minimumHeight")){
_a8.size.height=objj_msgSend(_a6,"minimumHeight");
}
if(objj_msgSend(_a6,"maximumHeight")!=0&&_a8.size.height>objj_msgSend(_a6,"maximumHeight")){
_a8.size.height=objj_msgSend(_a6,"maximumHeight");
}
_a8.size.height=floorf(_a8.size.height);
if(_a8.size.height<0){
_a8.size.height=0;
}
if(_a8.size.width<0){
_a8.size.width=0;
}
objj_msgSendSuper({receiver:_a6,super_class:objj_getClass("GDCellRenderObject").super_class},"setBounds:",_a8);
objj_msgSend(_a6,"updateCornerPoints");
objj_msgSend(textRenderObject,"adjustTextContainerSize");
}
}),new objj_method(sel_getUid("fullBounds"),function(_a9,_aa){
with(_a9){
var _ab=objj_msgSendSuper({receiver:_a9,super_class:objj_getClass("GDCellRenderObject").super_class},"fullBounds");
return CGRectMake(_ab.origin.x-objj_msgSend(_a9,"marginLeft"),_ab.origin.y-objj_msgSend(_a9,"marginTop"),_ab.size.width+objj_msgSend(_a9,"marginLeft")+objj_msgSend(_a9,"marginRight"),_ab.size.height+objj_msgSend(_a9,"marginTop")+objj_msgSend(_a9,"marginBottom"));
}
}),new objj_method(sel_getUid("setFullBounds:"),function(_ac,_ad,_ae){
with(_ac){
var _af=_ae.size.width-objj_msgSend(_ac,"marginLeft")-objj_msgSend(_ac,"marginRight");
if(_af<0){
_af=0;
}
var _b0=_ae.size.height-objj_msgSend(_ac,"marginTop")-objj_msgSend(_ac,"marginBottom");
if(_b0<0){
_b0=0;
}
var _b1=_ae.origin.x+objj_msgSend(_ac,"marginLeft");
var _b2=_ae.origin.y+objj_msgSend(_ac,"marginTop");
objj_msgSend(_ac,"setBounds:",NSMakeRect(_b1,_b2,_af,_b0));
}
}),new objj_method(sel_getUid("setFullX:"),function(_b3,_b4,_b5){
with(_b3){
objj_msgSend(_b3,"setX:",_b5+objj_msgSend(_b3,"marginLeft"));
}
}),new objj_method(sel_getUid("setFullY:"),function(_b6,_b7,_b8){
with(_b6){
objj_msgSend(_b6,"setY:",_b8+objj_msgSend(_b6,"marginTop"));
}
}),new objj_method(sel_getUid("setFullWidth:"),function(_b9,_ba,_bb){
with(_b9){
var _bc=_bb-objj_msgSend(_b9,"marginLeft")-objj_msgSend(_b9,"marginRight");
if(_bc<0){
_bc=0;
}
objj_msgSend(_b9,"setWidth:",_bc);
}
}),new objj_method(sel_getUid("setFullHeight:"),function(_bd,_be,_bf){
with(_bd){
var _c0=_bf-objj_msgSend(_bd,"marginTop")-objj_msgSend(_bd,"marginBottom");
if(_c0<0){
_c0=0;
}
objj_msgSend(_bd,"setHeight:",_c0);
}
}),new objj_method(sel_getUid("innerBounds"),function(_c1,_c2){
with(_c1){
var _c3=bounds;
return CGRectMake(_c3.origin.x+objj_msgSend(_c1,"borderLeftWidth")+objj_msgSend(_c1,"paddingLeft"),_c3.origin.y+objj_msgSend(_c1,"borderTopWidth")+objj_msgSend(_c1,"paddingTop"),_c3.size.width-objj_msgSend(_c1,"borderLeftWidth")-objj_msgSend(_c1,"borderRightWidth")-objj_msgSend(_c1,"paddingLeft")-objj_msgSend(_c1,"paddingRight"),_c3.size.height-objj_msgSend(_c1,"borderTopWidth")-objj_msgSend(_c1,"borderBottomWidth")-objj_msgSend(_c1,"paddingTop")-objj_msgSend(_c1,"paddingBottom"));
}
}),new objj_method(sel_getUid("setInnerBounds:"),function(_c4,_c5,r){
with(_c4){
objj_msgSend(_c4,"setBounds:",CGRectMake(r.origin.x-objj_msgSend(_c4,"paddingLeft")-objj_msgSend(_c4,"borderLeftWidth"),r.origin.y-objj_msgSend(_c4,"paddingTop")-objj_msgSend(_c4,"borderTopWidth"),r.size.width+objj_msgSend(_c4,"paddingLeft")+objj_msgSend(_c4,"paddingRight")+objj_msgSend(_c4,"borderLeftWidth")+objj_msgSend(_c4,"borderRightWidth"),r.size.height+objj_msgSend(_c4,"paddingTop")+objj_msgSend(_c4,"paddingBottom")+objj_msgSend(_c4,"borderTopWidth")+objj_msgSend(_c4,"borderBottomWidth")));
}
}),new objj_method(sel_getUid("setRotationAngle:"),function(_c6,_c7,_c8){
with(_c6){
if(rotationAngle==_c8){
return;
}
objj_msgSend(_c6,"willChangeValueForKey:","rotationAngle");
rotationAngle=_c8;
objj_msgSend(_c6,"didChangeValueForKey:","rotationAngle");
objj_msgSend(_c6,"updateCornerPoints");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",_c6);
}
}),new objj_method(sel_getUid("rotationAngle"),function(_c9,_ca){
with(_c9){
return rotationAngle;
}
}),new objj_method(sel_getUid("hasRoundedCorners"),function(_cb,_cc){
with(_cb){
return objj_msgSend(_cb,"cornerRadiusBottomLeft")!=0||objj_msgSend(_cb,"cornerRadiusBottomRight")!=0||objj_msgSend(_cb,"cornerRadiusTopLeft")!=0||objj_msgSend(_cb,"cornerRadiusTopRight")!=0;
}
}),new objj_method(sel_getUid("hasBorders"),function(_cd,_ce){
with(_cd){
return objj_msgSend(_cd,"borderTopWidth")>0||objj_msgSend(_cd,"borderLeftWidth")>0||objj_msgSend(_cd,"borderRightWidth")>0||objj_msgSend(_cd,"borderBottomWidth")>0;
}
}),new objj_method(sel_getUid("marginTop"),function(_cf,_d0){
with(_cf){
return marginTop;
}
}),new objj_method(sel_getUid("setMarginTop:"),function(_d1,_d2,_d3){
with(_d1){
if(_d3==marginTop){
return;
}
objj_msgSend(_d1,"willChangeValueForKey:","marginTop");
marginTop=_d3;
objj_msgSend(_d1,"didChangeValueForKey:","marginTop");
objj_msgSend(screenChangeManager,"renderObjectNeedsVerticalContainerLayout:",_d1);
}
}),new objj_method(sel_getUid("marginBottom"),function(_d4,_d5){
with(_d4){
return marginBottom;
}
}),new objj_method(sel_getUid("setMarginBottom:"),function(_d6,_d7,_d8){
with(_d6){
if(_d8==marginBottom){
return;
}
objj_msgSend(_d6,"willChangeValueForKey:","marginBottom");
marginBottom=_d8;
objj_msgSend(_d6,"didChangeValueForKey:","marginBottom");
objj_msgSend(screenChangeManager,"renderObjectNeedsVerticalContainerLayout:",_d6);
}
}),new objj_method(sel_getUid("marginLeft"),function(_d9,_da){
with(_d9){
return marginLeft;
}
}),new objj_method(sel_getUid("setMarginLeft:"),function(_db,_dc,_dd){
with(_db){
if(marginLeft==_dd){
return;
}
objj_msgSend(_db,"willChangeValueForKey:","marginLeft");
marginLeft=_dd;
objj_msgSend(_db,"didChangeValueForKey:","marginLeft");
objj_msgSend(screenChangeManager,"renderObjectNeedsHorizontalContainerLayout:",_db);
}
}),new objj_method(sel_getUid("marginRight"),function(_de,_df){
with(_de){
return marginRight;
}
}),new objj_method(sel_getUid("setMarginRight:"),function(_e0,_e1,_e2){
with(_e0){
if(marginRight==_e2){
return;
}
objj_msgSend(_e0,"willChangeValueForKey:","marginRight");
marginRight=_e2;
objj_msgSend(_e0,"didChangeValueForKey:","marginRight");
objj_msgSend(screenChangeManager,"renderObjectNeedsHorizontalContainerLayout:",_e0);
}
}),new objj_method(sel_getUid("setMargin:"),function(_e3,_e4,_e5){
with(_e3){
objj_msgSend(_e3,"setMarginBottom:",_e5);
objj_msgSend(_e3,"setMarginLeft:",_e5);
objj_msgSend(_e3,"setMarginRight:",_e5);
objj_msgSend(_e3,"setMarginTop:",_e5);
}
}),new objj_method(sel_getUid("paddingTop"),function(_e6,_e7){
with(_e6){
return paddingTop;
}
}),new objj_method(sel_getUid("setPaddingTop:"),function(_e8,_e9,_ea){
with(_e8){
if(paddingTop==_ea){
return;
}
objj_msgSend(_e8,"willChangeValueForKey:","paddingTop");
paddingTop=_ea;
objj_msgSend(_e8,"didChangeValueForKey:","paddingTop");
objj_msgSend(screenChangeManager,"renderObjectNeedsVerticalCellLayout:",_e8);
}
}),new objj_method(sel_getUid("paddingBottom"),function(_eb,_ec){
with(_eb){
return paddingBottom;
}
}),new objj_method(sel_getUid("setPaddingBottom:"),function(_ed,_ee,_ef){
with(_ed){
if(paddingBottom==_ef){
return;
}
objj_msgSend(_ed,"willChangeValueForKey:","paddingBottom");
paddingBottom=_ef;
objj_msgSend(_ed,"didChangeValueForKey:","paddingBottom");
objj_msgSend(screenChangeManager,"renderObjectNeedsVerticalCellLayout:",_ed);
}
}),new objj_method(sel_getUid("paddingLeft"),function(_f0,_f1){
with(_f0){
return paddingLeft;
}
}),new objj_method(sel_getUid("setPaddingLeft:"),function(_f2,_f3,_f4){
with(_f2){
if(paddingLeft==_f4){
return;
}
objj_msgSend(_f2,"willChangeValueForKey:","paddingLeft");
paddingLeft=_f4;
objj_msgSend(_f2,"didChangeValueForKey:","paddingLeft");
objj_msgSend(screenChangeManager,"renderObjectNeedsHorizontalCellLayout:",_f2);
}
}),new objj_method(sel_getUid("paddingRight"),function(_f5,_f6){
with(_f5){
return paddingRight;
}
}),new objj_method(sel_getUid("setPaddingRight:"),function(_f7,_f8,_f9){
with(_f7){
if(paddingRight==_f9){
return;
}
objj_msgSend(_f7,"willChangeValueForKey:","paddingRight");
paddingRight=_f9;
objj_msgSend(_f7,"didChangeValueForKey:","paddingRight");
objj_msgSend(screenChangeManager,"renderObjectNeedsHorizontalCellLayout:",_f7);
}
}),new objj_method(sel_getUid("setPadding:"),function(_fa,_fb,_fc){
with(_fa){
objj_msgSend(_fa,"setPaddingTop:",_fc);
objj_msgSend(_fa,"setPaddingLeft:",_fc);
objj_msgSend(_fa,"setPaddingBottom:",_fc);
objj_msgSend(_fa,"setPaddingRight:",_fc);
}
}),new objj_method(sel_getUid("horizontalAlignment"),function(_fd,_fe){
with(_fd){
return horizontalAlignment;
}
}),new objj_method(sel_getUid("setHorizontalAlignment:"),function(_ff,_100,_101){
with(_ff){
if(horizontalAlignment==_101){
return;
}
if(_101==null){
_101=0;
}
objj_msgSend(_ff,"willChangeValueForKey:","horizontalAlignment");
horizontalAlignment=_101;
objj_msgSend(_ff,"didChangeValueForKey:","horizontalAlignment");
objj_msgSend(screenChangeManager,"renderObjectNeedsHorizontalCellLayout:",_ff);
}
}),new objj_method(sel_getUid("verticalAlignment"),function(self,_102){
with(self){
return verticalAlignment;
}
}),new objj_method(sel_getUid("setVerticalAlignment:"),function(self,_103,_104){
with(self){
if(verticalAlignment==_104){
return;
}
if(_104==null){
_104=0;
...
}),new objj_method(sel_getUid("minimumWidth"),function(self,_105){
with(self){
return minimumWidth;
}
}),new objj_method(sel_getUid("setMinimumWidth:"),function(self,_106,_107){
with(self){
if(minimumWidth==_107){
return;
}
objj_msgSend(self,"willChangeValueForKey:","minimumWidth");
if(_107<maximumWidth){
minimumWidth=_107;
}else{
...
}),new objj_method(sel_getUid("maximumWidth"),function(self,_108){
with(self){
return maximumWidth;
}
}),new objj_method(sel_getUid("setMaximumWidth:"),function(self,_109,_10a){
with(self){
if(maximumWidth==_10a){
return;
}
objj_msgSend(self,"willChangeValueForKey:","maximumWidth");
if(_10a>minimumWidth){
maximumWidth=_10a;
}else{
...
}),new objj_method(sel_getUid("minimumHeight"),function(self,_10b){
with(self){
return minimumHeight;
}
}),new objj_method(sel_getUid("setMinimumHeight:"),function(self,_10c,_10d){
with(self){
if(minimumHeight==_10d){
return;
}
objj_msgSend(self,"willChangeValueForKey:","minimumHeight");
if(_10d<maximumHeight){
minimumHeight=_10d;
}else{
...
}),new objj_method(sel_getUid("maximumHeight"),function(self,_10e){
with(self){
return maximumHeight;
}
}),new objj_method(sel_getUid("setMaximumHeight:"),function(self,_10f,_110){
with(self){
if(maximumHeight==_110){
return;
}
objj_msgSend(self,"willChangeValueForKey:","maximumHeight");
if(_110>minimumHeight){
maximumHeight=_110;
}else{
...
}),new objj_method(sel_getUid("flexHeightPercentage"),function(self,_111){
with(self){
return flexHeightPercentage;
}
}),new objj_method(sel_getUid("setFlexHeightPercentage:"),function(self,_112,_113){
with(self){
if(flexHeightPercentage==_113){
return;
}
objj_msgSend(self,"willChangeValueForKey:","flexHeightPercentage");
flexHeightPercentage=_113;
objj_msgSend(self,"didChangeValueForKey:","flexHeightPercentage");
objj_msgSend(screenChangeManager,"renderObjectNeedsVerticalLayout:",self);
}
}),new objj_method(sel_getUid("flexWidthPercentage"),function(self,_114){
with(self){
return flexWidthPercentage;
}
}),new objj_method(sel_getUid("setFlexWidthPercentage:"),function(self,_115,_116){
with(self){
if(flexWidthPercentage==_116){
return;
}
objj_msgSend(self,"willChangeValueForKey:","flexWidthPercentage");
flexWidthPercentage=_116;
objj_msgSend(self,"didChangeValueForKey:","flexWidthPercentage");
objj_msgSend(screenChangeManager,"renderObjectNeedsHorizontalLayout:",self);
}
}),new objj_method(sel_getUid("verticalResizing"),function(self,_117){
with(self){
return verticalResizing;
}
}),new objj_method(sel_getUid("setVerticalResizing:"),function(self,_118,_119){
with(self){
if(_119==verticalResizing){
return;
}
if(_119==null){
_119=0;
...
verticalResizing=_119;
objj_msgSend(self,"didChangeValueForKey:","verticalResizing");
objj_msgSend(textRenderObject,"adjustTextContainerSize");
objj_msgSend(screenChangeManager,"renderObjectNeedsVerticalLayout:",self);
}
}),new objj_method(sel_getUid("horizontalResizing"),function(self,_11a){
with(self){
return horizontalResizing;
}
}),new objj_method(sel_getUid("setHorizontalResizing:"),function(self,_11b,_11c){
with(self){
if(horizontalResizing==_11c){
return;
}
if(_11c==null){
_11c=0;
...
horizontalResizing=_11c;
objj_msgSend(self,"didChangeValueForKey:","horizontalResizing");
if(_11c==GDIntrinsicResizing){
objj_msgSend(self,"setTextWordWrap:",NO);
}
objj_msgSend(textRenderObject,"adjustTextContainerSize");
objj_msgSend(screenChangeManager,"renderObjectNeedsHorizontalLayout:",self);
}
}),new objj_method(sel_getUid("borderTopWidth"),function(self,_11d){
with(self){
return borderTopWidth;
}
}),new objj_method(sel_getUid("setBorderTopWidth:"),function(self,_11e,_11f){
with(self){
if(borderTopWidth==_11f){
return;
}
...
}),new objj_method(sel_getUid("borderLeftWidth"),function(self,_120){
with(self){
return borderLeftWidth;
}
}),new objj_method(sel_getUid("setBorderLeftWidth:"),function(self,_121,_122){
with(self){
if(borderLeftWidth==_122){
return;
}
if(!objj_msgSend(self,"isContentClipped")){
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
...
}),new objj_method(sel_getUid("borderBottomWidth"),function(self,_123){
with(self){
return borderBottomWidth;
}
}),new objj_method(sel_getUid("setBorderBottomWidth:"),function(self,_124,_125){
with(self){
if(borderBottomWidth==_125){
return;
}
if(!objj_msgSend(self,"isContentClipped")){
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
...
borderBottomWidth=_125;
objj_msgSend(self,"didChangeValueForKey:","borderBottomWidth");
objj_msgSend(screenChangeManager,"renderObjectNeedsVerticalCellLayout:",self);
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("borderRightWidth"),function(self,_126){
with(self){
return borderRightWidth;
}
}),new objj_method(sel_getUid("setBorderRightWidth:"),function(self,_127,_128){
with(self){
if(borderRightWidth==_128){
return;
}
if(!objj_msgSend(self,"isContentClipped")){
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
...
borderRightWidth=_128;
objj_msgSend(self,"didChangeValueForKey:","borderRightWidth");
objj_msgSend(screenChangeManager,"renderObjectNeedsHorizontalCellLayout:",self);
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setBorderWidth:"),function(self,_129,_12a){
with(self){
objj_msgSend(self,"setBorderBottomWidth:",_12a);
objj_msgSend(self,"setBorderTopWidth:",_12a);
objj_msgSend(self,"setBorderLeftWidth:",_12a);
objj_msgSend(self,"setBorderRightWidth:",_12a);
}
}),new objj_method(sel_getUid("borderTopWidthAdjusted"),function(self,_12b){
with(self){
return borderTopWidthAdjusted;
}
}),new objj_method(sel_getUid("setBorderTopWidthAdjusted:"),function(self,_12c,_12d){
with(self){
borderTopWidthAdjusted=_12d;
}
}),new objj_method(sel_getUid("borderBottomWidthAdjusted"),function(self,_12e){
with(self){
return borderBottomWidthAdjusted;
}
}),new objj_method(sel_getUid("setBorderBottomWidthAdjusted:"),function(self,_12f,_130){
with(self){
borderBottomWidthAdjusted=_130;
}
}),new objj_method(sel_getUid("borderLeftWidthAdjusted"),function(self,_131){
with(self){
return borderLeftWidthAdjusted;
}
}),new objj_method(sel_getUid("setBorderLeftWidthAdjusted:"),function(self,_132,_133){
with(self){
borderLeftWidthAdjusted=_133;
}
}),new objj_method(sel_getUid("borderRightWidthAdjusted"),function(self,_134){
with(self){
return borderRightWidthAdjusted;
}
}),new objj_method(sel_getUid("setBorderRightWidthAdjusted:"),function(self,_135,_136){
with(self){
borderRightWidthAdjusted=_136;
}
}),new objj_method(sel_getUid("borderBottomColor"),function(self,_137){
with(self){
return borderBottomColor;
}
}),new objj_method(sel_getUid("setBorderBottomColor:"),function(self,_138,_139){
with(self){
if(borderBottomColor==_139){
return;
}
objj_msgSend(self,"willChangeValueForKey:","borderBottomColor");
objj_msgSend(borderBottomColor,"release");
borderBottomColor=objj_msgSend(_139,"retain");
objj_msgSend(self,"didChangeValueForKey:","borderBottomColor");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("borderLeftColor"),function(self,_13a){
with(self){
return borderLeftColor;
}
}),new objj_method(sel_getUid("setBorderLeftColor:"),function(self,_13b,_13c){
with(self){
if(borderLeftColor==_13c){
return;
}
objj_msgSend(self,"willChangeValueForKey:","borderLeftColor");
objj_msgSend(borderLeftColor,"release");
borderLeftColor=objj_msgSend(_13c,"retain");
objj_msgSend(self,"didChangeValueForKey:","borderLeftColor");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("borderRightColor"),function(self,_13d){
with(self){
return borderRightColor;
}
}),new objj_method(sel_getUid("setBorderRightColor:"),function(self,_13e,_13f){
with(self){
if(borderRightColor==_13f){
return;
}
objj_msgSend(self,"willChangeValueForKey:","borderRightColor");
objj_msgSend(borderRightColor,"release");
borderRightColor=objj_msgSend(_13f,"retain");
objj_msgSend(self,"didChangeValueForKey:","borderRightColor");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("borderTopColor"),function(self,_140){
with(self){
return borderTopColor;
}
}),new objj_method(sel_getUid("setBorderTopColor:"),function(self,_141,_142){
with(self){
if(borderTopColor==_142){
return;
}
objj_msgSend(self,"willChangeValueForKey:","borderTopColor");
objj_msgSend(borderTopColor,"release");
borderTopColor=objj_msgSend(_142,"retain");
objj_msgSend(self,"didChangeValueForKey:","borderTopColor");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("borderTopType"),function(self,_143){
with(self){
return borderTopType;
}
}),new objj_method(sel_getUid("borderBottomType"),function(self,_144){
with(self){
return borderBottomType;
}
}),new objj_method(sel_getUid("borderLeftType"),function(self,_145){
with(self){
return borderLeftType;
}
}),new objj_method(sel_getUid("borderRightType"),function(self,_146){
with(self){
return borderRightType;
}
}),new objj_method(sel_getUid("setBorderTopType:"),function(self,_147,_148){
with(self){
if(borderTopType==_148){
return;
}
...
}),new objj_method(sel_getUid("setBorderBottomType:"),function(self,_149,_14a){
with(self){
if(borderBottomType==_14a){
return;
}
objj_msgSend(self,"willChangeValueForKey:","borderBottomType");
borderBottomType=_14a;
objj_msgSend(self,"didChangeValueForKey:","borderBottomType");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setBorderLeftType:"),function(self,_14b,_14c){
with(self){
if(borderLeftType==_14c){
return;
}
...
}),new objj_method(sel_getUid("setBorderRightType:"),function(self,_14d,_14e){
with(self){
if(borderRightType==_14e){
return;
}
objj_msgSend(self,"willChangeValueForKey:","borderRightType");
borderRightType=_14e;
objj_msgSend(self,"didChangeValueForKey:","borderRightType");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("borderGradient"),function(self,_14f){
with(self){
return borderGradient;
}
}),new objj_method(sel_getUid("borderGradientFill"),function(self,_150){
with(self){
return borderGradientFill;
}
}),new objj_method(sel_getUid("borderGradientIsRadial"),function(self,_151){
with(self){
return borderGradientIsRadial;
}
}),new objj_method(sel_getUid("borderGradientAngle"),function(self,_152){
with(self){
return borderGradientAngle;
}
}),new objj_method(sel_getUid("setBorderGradient:"),function(self,_153,_154){
with(self){
if(borderGradient==_154){
return;
}
...
}),new objj_method(sel_getUid("setBorderGradientFill:"),function(self,_155,_156){
with(self){
if(borderGradientFill==_156){
return;
}
objj_msgSend(self,"willChangeValueForKey:","borderGradientFill");
objj_msgSend(borderGradientFill,"release");
borderGradientFill=objj_msgSend(_156,"retain");
objj_msgSend(self,"didChangeValueForKey:","borderGradientFill");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setBorderGradientIsRadial:"),function(self,_157,_158){
with(self){
if(borderGradientIsRadial==_158){
return;
}
objj_msgSend(self,"willChangeValueForKey:","borderGradientIsRadial");
borderGradientIsRadial=_158;
objj_msgSend(self,"didChangeValueForKey:","borderGradientIsRadial");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setBorderGradientAngle:"),function(self,_159,_15a){
with(self){
if(borderGradientAngle==_15a){
return;
}
objj_msgSend(self,"willChangeValueForKey:","borderGradientAngle");
borderGradientAngle=_15a;
objj_msgSend(self,"didChangeValueForKey:","borderGradientAngle");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("cornerRadiusTopLeft"),function(self,_15b){
with(self){
return cornerRadiusTopLeft;
}
}),new objj_method(sel_getUid("setCornerRadiusTopLeft:"),function(self,_15c,_15d){
with(self){
if(cornerRadiusTopLeft==_15d){
return;
}
objj_msgSend(self,"willChangeValueForKey:","cornerRadiusTopLeft");
cornerRadiusTopLeft=_15d;
objj_msgSend(self,"didChangeValueForKey:","cornerRadiusTopLeft");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("cornerRadiusTopRight"),function(self,_15e){
with(self){
return cornerRadiusTopRight;
}
}),new objj_method(sel_getUid("setCornerRadiusTopRight:"),function(self,_15f,_160){
with(self){
if(cornerRadiusTopRight==_160){
return;
}
objj_msgSend(self,"willChangeValueForKey:","cornerRadiusTopRight");
cornerRadiusTopRight=_160;
objj_msgSend(self,"didChangeValueForKey:","cornerRadiusTopRight");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("cornerRadiusBottomLeft"),function(self,_161){
with(self){
return cornerRadiusBottomLeft;
}
}),new objj_method(sel_getUid("setCornerRadiusBottomLeft:"),function(self,_162,_163){
with(self){
if(cornerRadiusBottomLeft==_163){
return;
}
objj_msgSend(self,"willChangeValueForKey:","cornerRadiusBottomLeft");
cornerRadiusBottomLeft=_163;
objj_msgSend(self,"didChangeValueForKey:","cornerRadiusBottomLeft");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("cornerRadiusBottomRight"),function(self,_164){
with(self){
return cornerRadiusBottomRight;
}
}),new objj_method(sel_getUid("setCornerRadiusBottomRight:"),function(self,_165,_166){
with(self){
if(cornerRadiusBottomRight==_166){
return;
}
objj_msgSend(self,"willChangeValueForKey:","cornerRadiusBottomRight");
cornerRadiusBottomRight=_166;
objj_msgSend(self,"didChangeValueForKey:","cornerRadiusBottomRight");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("cornerRadiusTopLeftAdjusted"),function(self,_167){
with(self){
return cornerRadiusTopLeftAdjusted;
}
}),new objj_method(sel_getUid("cornerRadiusTopRightAdjusted"),function(self,_168){
with(self){
return cornerRadiusTopRightAdjusted;
}
}),new objj_method(sel_getUid("cornerRadiusBottomLeftAdjusted"),function(self,_169){
with(self){
return cornerRadiusBottomLeftAdjusted;
}
}),new objj_method(sel_getUid("cornerRadiusBottomRightAdjusted"),function(self,_16a){
with(self){
return cornerRadiusBottomRightAdjusted;
}
}),new objj_method(sel_getUid("background"),function(self,_16b){
with(self){
return background;
}
}),new objj_method(sel_getUid("setBackground:"),function(self,_16c,_16d){
with(self){
if(background==_16d){
return;
}
...
background=objj_msgSend(_16d,"retain");
objj_msgSend(self,"didChangeValueForKey:","background");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("backgroundColor"),function(self,_16e){
with(self){
...
}),new objj_method(sel_getUid("setBackgroundColor:"),function(self,_16f,_170){
with(self){
if(background!=nil&&objj_msgSend(background,"isColorPainter")){
objj_msgSend(background,"setColor:",_170);
}
}
}),new objj_method(sel_getUid("backgroundGradient"),function(self,_171){
with(self){
...
}),new objj_method(sel_getUid("setBackgroundGradient:"),function(self,_172,_173){
with(self){
if(objj_msgSend(background,"isGradientPainter")){
objj_msgSend(background,"setGradient:",_173);
}
}
}),new objj_method(sel_getUid("backgroundGradientAngle"),function(self,_174){
with(self){
if(objj_msgSend(background,"isGradientPainter")){
...
}),new objj_method(sel_getUid("setBackgroundGradientAngle:"),function(self,_175,_176){
with(self){
if(objj_msgSend(background,"isGradientPainter")){
objj_msgSend(background,"setAngle:",_176);
}
}
}),new objj_method(sel_getUid("backgroundGradientIsRadial"),function(self,_177){
with(self){
if(objj_msgSend(background,"isGradientPainter")){
...
}),new objj_method(sel_getUid("setBackgroundGradientIsRadial:"),function(self,_178,_179){
with(self){
if(objj_msgSend(background,"isGradientPainter")){
objj_msgSend(background,"setIsRadial:",_179);
}
}
}),new objj_method(sel_getUid("backgroundImageResource"),function(self,_17a){
with(self){
...
}),new objj_method(sel_getUid("setBackgroundImageResource:"),function(self,_17b,_17c){
with(self){
if(objj_msgSend(background,"isImagePainter")){
objj_msgSend(background,"setImageData:",objj_msgSend(_17c,"data"));
}
}
}),new objj_method(sel_getUid("backgroundImageHorizontalAlignment"),function(self,_17d){
with(self){
if(objj_msgSend(background,"isImagePainter")){
...
}),new objj_method(sel_getUid("setBackgroundImageHorizontalAlignment:"),function(self,_17e,_17f){
with(self){
if(objj_msgSend(background,"isImagePainter")){
return objj_msgSend(background,"setHorizontalAlignment:",_17f);
}
}
}),new objj_method(sel_getUid("backgroundImageVerticalAlignment"),function(self,_180){
with(self){
if(objj_msgSend(background,"isImagePainter")){
...
}),new objj_method(sel_getUid("setBackgroundImageVerticalAlignment:"),function(self,_181,_182){
with(self){
if(objj_msgSend(background,"isImagePainter")){
return objj_msgSend(background,"setVerticalAlignment:",_182);
}
}
}),new objj_method(sel_getUid("backgroundImageHorizontalOperation"),function(self,_183){
with(self){
if(objj_msgSend(background,"isImagePainter")){
...
}),new objj_method(sel_getUid("setBackgroundImageHorizontalOperation:"),function(self,_184,_185){
with(self){
if(objj_msgSend(background,"isImagePainter")){
objj_msgSend(background,"setHorizontalOperation:",_185);
}
}
}),new objj_method(sel_getUid("backgroundImageVerticalOperation"),function(self,_186){
with(self){
if(objj_msgSend(background,"isImagePainter")){
...
}),new objj_method(sel_getUid("setBackgroundImageVerticalOperation:"),function(self,_187,_188){
with(self){
if(objj_msgSend(background,"isImagePainter")){
objj_msgSend(background,"setVerticalOperation:",_188);
}
}
}),new objj_method(sel_getUid("setBackgroundImageProportionalScale:"),function(self,_189,_18a){
with(self){
if(objj_msgSend(background,"isImagePainter")){
objj_msgSend(background,"setProportionalScale:",_18a);
}
}
}),new objj_method(sel_getUid("backgroundImageProportionalScale"),function(self,_18b){
with(self){
if(objj_msgSend(background,"isImagePainter")){
...
}),new objj_method(sel_getUid("setDropShadow:"),function(self,_18c,_18d){
with(self){
if(dropShadow===_18d){
return;
}
...
}),new objj_method(sel_getUid("setDropShadowAngle:"),function(self,_18e,_18f){
with(self){
if(dropShadowAngle===_18f){
return;
}
dropShadowAngle=_18f;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setDropShadowSize:"),function(self,_190,_191){
with(self){
if(dropShadowSize===_191){
return;
}
dropShadowSize=_191;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setDropShadowOffset:"),function(self,_192,_193){
with(self){
if(dropShadowOffset===_193){
return;
}
dropShadowOffset=_193;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setDropShadowBlur:"),function(self,_194,_195){
with(self){
if(dropShadowBlur===_195){
return;
}
dropShadowBlur=_195;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setDropShadowOpacity:"),function(self,_196,_197){
with(self){
if(dropShadowOpacity===_197){
return;
}
dropShadowOpacity=_197;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setDropShadowColor:"),function(self,_198,_199){
with(self){
if(objj_msgSend(dropShadowColor,"isEqual:",_199)){
return;
}
dropShadowColor=_199;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setInnerShadow:"),function(self,_19a,_19b){
with(self){
if(innerShadow===_19b){
return;
}
...
}),new objj_method(sel_getUid("setInnerShadowAngle:"),function(self,_19c,_19d){
with(self){
if(innerShadowAngle===_19d){
return;
}
innerShadowAngle=_19d;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setInnerShadowOffset:"),function(self,_19e,_19f){
with(self){
if(innerShadowOffset===_19f){
return;
}
innerShadowOffset=_19f;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setInnerShadowBlur:"),function(self,_1a0,_1a1){
with(self){
if(innerShadowBlur===_1a1){
return;
}
innerShadowBlur=_1a1;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setInnerShadowOpacity:"),function(self,_1a2,_1a3){
with(self){
if(innerShadowOpacity===_1a3){
return;
}
innerShadowOpacity=_1a3;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setInnerShadowColor:"),function(self,_1a4,_1a5){
with(self){
if(objj_msgSend(innerShadowColor,"isEqual:",_1a5)){
return;
}
innerShadowColor=_1a5;
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("hasTextContent"),function(self,_1a6){
with(self){
return textRenderObject!=nil&&objj_msgSend(textRenderObject,"attributedString")!="";
}
}),new objj_method(sel_getUid("textLocation"),function(self,_1a7){
with(self){
return objj_msgSend(textRenderObject,"textLocation");
}
}),new objj_method(sel_getUid("textContainer"),function(self,_1a8){
with(self){
return objj_msgSend(textRenderObject,"textContainer");
}
}),new objj_method(sel_getUid("hideText"),function(self,_1a9){
with(self){
objj_msgSend(textRenderObject,"hideText");
}
}),new objj_method(sel_getUid("showText"),function(self,_1aa){
with(self){
objj_msgSend(textRenderObject,"showText");
}
}),new objj_method(sel_getUid("textAntialias"),function(self,_1ab){
with(self){
return objj_msgSend(textRenderObject,"antialias");
}
}),new objj_method(sel_getUid("setTextAntialias:"),function(self,_1ac,_1ad){
with(self){
objj_msgSend(self,"willChangeValueForKey:","textAntialias");
objj_msgSend(textRenderObject,"setAntialias:",_1ad);
objj_msgSend(self,"didChangeValueForKey:","textAntialias");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("textHorizontalAlignment"),function(self,_1ae){
with(self){
return objj_msgSend(textRenderObject,"horizontalAlignment");
}
}),new objj_method(sel_getUid("setTextHorizontalAlignment:"),function(self,_1af,_1b0){
with(self){
objj_msgSend(self,"willChangeValueForKey:","textHorizontalAlignment");
objj_msgSend(textRenderObject,"setHorizontalAlignment:",_1b0);
objj_msgSend(self,"didChangeValueForKey:","textHorizontalAlignment");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("textVerticalAlignment"),function(self,_1b1){
with(self){
return objj_msgSend(textRenderObject,"verticalAlignment");
}
}),new objj_method(sel_getUid("setTextVerticalAlignment:"),function(self,_1b2,_1b3){
with(self){
objj_msgSend(self,"willChangeValueForKey:","textVerticalAlignment");
objj_msgSend(textRenderObject,"setVerticalAlignment:",_1b3);
objj_msgSend(self,"didChangeValueForKey:","textVerticalAlignment");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("textColor"),function(self,_1b4){
with(self){
return objj_msgSend(textRenderObject,"textColor");
}
}),new objj_method(sel_getUid("setTextColor:"),function(self,_1b5,_1b6){
with(self){
if(objj_msgSend(_1b6,"isEqual:",objj_msgSend(textRenderObject,"textColor"))){
return;
}
objj_msgSend(self,"willChangeValueForKey:","textColor");
objj_msgSend(textRenderObject,"setTextColor:",_1b6);
objj_msgSend(self,"didChangeValueForKey:","textColor");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("textFont"),function(self,_1b7){
with(self){
return objj_msgSend(textRenderObject,"font");
}
}),new objj_method(sel_getUid("setTextFont:"),function(self,_1b8,font){
with(self){
...
}),new objj_method(sel_getUid("textAttributedString"),function(self,_1b9){
with(self){
return objj_msgSend(textRenderObject,"attributedString");
}
}),new objj_method(sel_getUid("setTextRenderObject:"),function(self,_1ba,_1bb){
with(self){
if(textRenderObject==_1bb){
return;
}
objj_msgSend(self,"willChangeValueForKey:","textRenderObject");
objj_msgSend(textRenderObject,"release");
textRenderObject=objj_msgSend(_1bb,"retain");
objj_msgSend(self,"didChangeValueForKey:","textRenderObject");
}
}),new objj_method(sel_getUid("assureTextRenderObjectExists"),function(self,_1bc){
with(self){
...
}),new objj_method(sel_getUid("setTextAttributedString:"),function(self,_1bd,_1be){
with(self){
if(_1be==nil){
return;
}
if(objj_msgSend(_1be,"isEqual:",objj_msgSend(textRenderObject,"attributedString"))){
return;
}
objj_msgSend(self,"assureTextRenderObjectExists");
objj_msgSend(self,"willChangeValueForKey:","textAttributedString");
objj_msgSend(textRenderObject,"setAttributedString:",_1be);
...
}),new objj_method(sel_getUid("textStringValue"),function(self,_1bf){
with(self){
return objj_msgSend(textRenderObject,"stringValue");
}
}),new objj_method(sel_getUid("setTextStringValue:"),function(self,_1c0,_1c1){
with(self){
objj_msgSend(self,"assureTextRenderObjectExists");
...
objj_msgSend(textRenderObject,"setStringValue:",_1c1);
}
...
}),new objj_method(sel_getUid("textWordWrap"),function(self,_1c2){
with(self){
return objj_msgSend(textRenderObject,"wordWrap");
}
}),new objj_method(sel_getUid("setTextWordWrap:"),function(self,_1c3,_1c4){
with(self){
if(_1c4==objj_msgSend(textRenderObject,"wordWrap")){
return;
}
objj_msgSend(self,"willChangeValueForKey:","textWordWrap");
objj_msgSend(textRenderObject,"setWordWrap:",_1c4);
...
}),new objj_method(sel_getUid("textLineHeight"),function(self,_1c5){
with(self){
return objj_msgSend(textRenderObject,"lineHeight");
}
}),new objj_method(sel_getUid("setTextLineHeight:"),function(self,_1c6,_1c7){
with(self){
if(!objj_msgSend(self,"isContentClipped")){
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
objj_msgSend(self,"willChangeValueForKey:","textLineHeight");
objj_msgSend(textRenderObject,"setLineHeight:",_1c7);
...
}),new objj_method(sel_getUid("textLineHeightMultiply"),function(self,_1c8){
with(self){
return objj_msgSend(textRenderObject,"lineHeightMultiply");
}
}),new objj_method(sel_getUid("setTextLineHeightMultiply:"),function(self,_1c9,_1ca){
with(self){
if(!objj_msgSend(self,"isContentClipped")){
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
objj_msgSend(self,"willChangeValueForKey:","textLineHeightMultiply");
objj_msgSend(textRenderObject,"setLineHeightMultiply:",_1ca);
...
}),new objj_method(sel_getUid("baseline"),function(self,_1cb){
with(self){
return objj_msgSend(textRenderObject,"baseline");
}
}),new objj_method(sel_getUid("textSize"),function(self,_1cc){
with(self){
...
}),new objj_method(sel_getUid("textWidth"),function(self,_1cd){
with(self){
return objj_msgSend(self,"textSize").width;
}
}),new objj_method(sel_getUid("textHeight"),function(self,_1ce){
with(self){
return objj_msgSend(self,"textSize").height;
}
}),new objj_method(sel_getUid("setTextShadow:"),function(self,_1cf,_1d0){
with(self){
objj_msgSend(textRenderObject,"setTextShadow:",_1d0);
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setTextShadowOffset:"),function(self,_1d1,_1d2){
with(self){
objj_msgSend(textRenderObject,"setTextShadowOffset:",_1d2);
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setTextShadowOpacity:"),function(self,_1d3,_1d4){
with(self){
objj_msgSend(textRenderObject,"setTextShadowOpacity:",_1d4);
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setTextShadowAngle:"),function(self,_1d5,_1d6){
with(self){
objj_msgSend(textRenderObject,"setTextShadowAngle:",_1d6);
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setTextShadowBlur:"),function(self,_1d7,_1d8){
with(self){
objj_msgSend(textRenderObject,"setTextShadowBlur:",_1d8);
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("setTextShadowColor:"),function(self,_1d9,_1da){
with(self){
objj_msgSend(textRenderObject,"setTextShadowColor:",_1da);
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("textShadow"),function(self,_1db){
with(self){
return objj_msgSend(textRenderObject,"textShadow");
}
}),new objj_method(sel_getUid("textShadowOffset"),function(self,_1dc){
with(self){
return objj_msgSend(textRenderObject,"textShadowOffset");
}
}),new objj_method(sel_getUid("textShadowOpacity"),function(self,_1dd){
with(self){
return objj_msgSend(textRenderObject,"textShadowOpacity");
}
}),new objj_method(sel_getUid("textShadowBlur"),function(self,_1de){
with(self){
return objj_msgSend(textRenderObject,"textShadowBlur");
}
}),new objj_method(sel_getUid("textShadowAngle"),function(self,_1df){
with(self){
return objj_msgSend(textRenderObject,"textShadowAngle");
}
}),new objj_method(sel_getUid("textShadowColor"),function(self,_1e0){
with(self){
return objj_msgSend(textRenderObject,"textShadowColor");
}
}),new objj_method(sel_getUid("opacity"),function(self,_1e1){
with(self){
return opacity;
}
}),new objj_method(sel_getUid("setOpacity:"),function(self,_1e2,_1e3){
with(self){
if(opacity==_1e3){
return;
}
...
}),new objj_method(sel_getUid("isContentClipped"),function(self,_1e4){
with(self){
return isContentClipped;
}
}),new objj_method(sel_getUid("setIsContentClipped:"),function(self,_1e5,_1e6){
with(self){
if(isContentClipped==_1e6){
return;
}
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
objj_msgSend(self,"willChangeValueForKey:","isContentClipped");
isContentClipped=_1e6;
objj_msgSend(self,"didChangeValueForKey:","isContentClipped");
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("isDropTarget"),function(self,_1e7){
with(self){
return isDropTarget;
}
}),new objj_method(sel_getUid("setIsDropTarget:"),function(self,_1e8,_1e9){
with(self){
if(_1e9==isDropTarget){
return;
}
...
}),new objj_method(sel_getUid("defaultVerticalSquareBorderStart"),function(self,_1ea){
with(self){
return borderTopWidthAdjusted;
}
}),new objj_method(sel_getUid("defaultVerticalSquareBorderEnd"),function(self,_1eb){
with(self){
return objj_msgSend(self,"height")-borderBottomWidthAdjusted;
}
}),new objj_method(sel_getUid("borderOverlap"),function(self,_1ec){
with(self){
return GDBorderOverlap;
}
}),new objj_method(sel_getUid("adjustRoundedCornersToAvailableSize"),function(self,_1ed){
with(self){
var _1ee=objj_msgSend(self,"width");
var _1ef=objj_msgSend(self,"height");
...
var _1f0=cornerRadiusBottomLeftAdjusted;
var _1f1=cornerRadiusBottomRightAdjusted;
var _1f2=cornerRadiusTopLeftAdjusted;
var _1f3=cornerRadiusTopRightAdjusted;
var _1f4=(_1f2+_1f3)-_1ee;
var _1f5=(_1f0+_1f1)-_1ee;
while(_1f4>0){
...
var _1f6=cornerRadiusBottomLeftAdjusted;
var _1f7=cornerRadiusBottomRightAdjusted;
var _1f8=cornerRadiusTopLeftAdjusted;
var _1f9=cornerRadiusTopRightAdjusted;
var _1fa=(_1f8+_1f6)-_1ef;
var _1fb=(_1f9+_1f7)-_1ef;
while(_1fa>0){
...
}),new objj_method(sel_getUid("adjustBordersToAvailableSize"),function(self,_1fc){
with(self){
var _1fd=objj_msgSend(self,"width");
var _1fe=objj_msgSend(self,"height");
...
var _1ff=(borderLeftWidthAdjusted+borderRightWidthAdjusted)-_1fd;
while(_1ff>0){
...
var _200=(borderTopWidthAdjusted+borderBottomWidthAdjusted)-_1fe;
while(_200>0){
...
_202+=borderRightWidthAdjusted;
}
if(cornerRadiusBottomRightAdjusted>0){
_202+=borderRightWidthAdjusted;
}
if(_201>_1fe){
borderLeftWidthAdjusted=_1fe-borderLeftWidthAdjusted;
...
if(_202>_1fe){
borderRightWidthAdjusted=_1fe-borderRightWidthAdjusted;
...
var _204=0;
if(cornerRadiusBottomLeftAdjusted>0){
_204+=borderBottomWidthAdjusted;
}
if(cornerRadiusBottomRightAdjusted>0){
_204+=borderBottomWidthAdjusted;
}
if(_203>_1fd){
borderTopWidthAdjusted=_1fd-borderTopWidthAdjusted;
...
if(_204>_1fd){
borderBottomWidthAdjusted=_1fd-borderBottomWidthAdjusted;
...
}),new objj_method(sel_getUid("adjustBordersAndCornersToAvailableSize"),function(self,_205){
with(self){
objj_msgSend(self,"adjustRoundedCornersToAvailableSize");
objj_msgSend(self,"adjustBordersToAvailableSize");
}
}),new objj_method(sel_getUid("drawBorderPath:inContext:borderType:borderWidth:phase:"),function(self,_206,path,_207,_208,_209,_20a){
with(self){
if(CGPathIsEmpty(path)){
return;
}
CGContextSetLineWidth(_207,_209+objj_msgSend(self,"borderOverlap"));
switch(_208){
case GDBorderTypeDashed:
var _20b=new Array(_209*GDBorderTypeDashedFill,_209*GDBorderTypeDashedSpace);
CGContextStrokeDashedPath(_207,path,_20b,_20a);
break;
case GDBorderTypeDotted:
var _20b=new Array(_209*GDBorderTypeDottedFill,_209*GDBorderTypeDottedSpace);
CGContextStrokeDashedPath(_207,path,_20b,_20a);
break;
case GDBorderTypeSolid:
CGContextBeginPath(_207);
CGContextAddPath(_207,path);
CGContextStrokePath(_207);
}
}
}),new objj_method(sel_getUid("drawTopBorderWithPhase:"),function(self,_20c,_20d){
with(self){
var _20e=GDGetCurrentContext();
var path=CGPathCreateMutable();
var _20f=objj_msgSend(self,"addTopBorderToStrokePath:inputPhase:",path,_20d);
CGContextSaveGState(_20e);
CGContextSetStrokeColorWithAlpha(_20e,borderTopColor,objj_msgSend(borderTopColor,"alphaComponent"));
objj_msgSend(self,"drawBorderPath:inContext:borderType:borderWidth:phase:",path,_20e,objj_msgSend(self,"borderTopType"),objj_msgSend(self,"borderTopWidthAdjusted"),_20d);
CGContextRestoreGState(_20e);
CGPathRelease(path);
return _20f;
}
}),new objj_method(sel_getUid("drawRightBorderWithPhase:"),function(self,_210,_211){
with(self){
var _212=GDGetCurrentContext();
var path=CGPathCreateMutable();
var _213=objj_msgSend(self,"addRightBorderToStrokePath:inputPhase:",path,_211);
CGContextSaveGState(_212);
CGContextSetStrokeColorWithAlpha(_212,borderRightColor,objj_msgSend(borderRightColor,"alphaComponent"));
objj_msgSend(self,"drawBorderPath:inContext:borderType:borderWidth:phase:",path,_212,objj_msgSend(self,"borderRightType"),objj_msgSend(self,"borderRightWidthAdjusted"),_211);
CGContextRestoreGState(_212);
CGPathRelease(path);
return _213;
}
}),new objj_method(sel_getUid("drawBottomBorderWithPhase:"),function(self,_214,_215){
with(self){
var _216=GDGetCurrentContext();
var path=CGPathCreateMutable();
var _217=objj_msgSend(self,"addBottomBorderToStrokePath:inputPhase:",path,_215);
CGContextSaveGState(_216);
CGContextSetStrokeColorWithAlpha(_216,borderBottomColor,objj_msgSend(borderBottomColor,"alphaComponent"));
objj_msgSend(self,"drawBorderPath:inContext:borderType:borderWidth:phase:",path,_216,objj_msgSend(self,"borderBottomType"),objj_msgSend(self,"borderBottomWidthAdjusted"),_215);
CGContextRestoreGState(_216);
CGPathRelease(path);
return _217;
}
}),new objj_method(sel_getUid("drawLeftBorderWithPhase:"),function(self,_218,_219){
with(self){
var _21a=GDGetCurrentContext();
var path=CGPathCreateMutable();
var _21b=objj_msgSend(self,"addLeftBorderToStrokePath:inputPhase:",path,_219);
CGContextSaveGState(_21a);
CGContextSetStrokeColorWithAlpha(_21a,borderLeftColor,objj_msgSend(borderLeftColor,"alphaComponent"));
objj_msgSend(self,"drawBorderPath:inContext:borderType:borderWidth:phase:",path,_21a,objj_msgSend(self,"borderLeftType"),objj_msgSend(self,"borderLeftWidthAdjusted"),_219);
CGContextRestoreGState(_21a);
CGPathRelease(path);
return _21b;
}
}),new objj_method(sel_getUid("addTopBorderToStrokePath:inputPhase:"),function(self,_21c,_21d,_21e){
with(self){
if(borderTopWidthAdjusted<=0){
return 0;
}
var _21f=borderTopWidthAdjusted;
var _220=0;
var _221=0;
var _222=_21f-((_21f+objj_msgSend(self,"borderOverlap"))/2);
if(cornerRadiusTopLeftAdjusted>0){
if(cornerRadiusTopLeftAdjusted>_21f){
CGPathAddArc(_21d,NULL,cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted-_222,M_PI+M_PI_4,M_PI+M_PI_2,0);
_220+=(M_PI_4*(cornerRadiusTopLeftAdjusted-_222));
_221=cornerRadiusTopLeftAdjusted;
}else{
CGPathMoveToPoint(_21d,NULL,_21f,_222);
_221=_21f;
}
}else{
CGPathMoveToPoint(_21d,NULL,0,_222);
_221=0;
}
var _223=0;
if(cornerRadiusTopRightAdjusted<=0){
_223=objj_msgSend(self,"width");
}else{
if(cornerRadiusTopRightAdjusted<_21f){
_223=objj_msgSend(self,"width")-_21f;
}else{
_223=objj_msgSend(self,"width")-cornerRadiusTopRightAdjusted;
}
}
CGPathAddLineToPoint(_21d,NULL,_223,_222);
_220+=(_223-_221);
var _224=0;
if(cornerRadiusTopRightAdjusted>0){
if(cornerRadiusTopRightAdjusted>_21f){
CGPathAddArc(_21d,NULL,objj_msgSend(self,"width")-cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted-_222,M_PI+M_PI_2,M_PI+M_PI_2+M_PI_4,0);
_220+=M_PI_4*(cornerRadiusTopRightAdjusted-_222);
_224=outputPhaseForBorder(objj_msgSend(self,"borderTopType"),_21f,_220,_21e);
}
}else{
_224=outputPhaseForBorder(objj_msgSend(self,"borderTopType"),_21f,_220,_21e);
}
...
}),new objj_method(sel_getUid("addRightBorderToStrokePath:inputPhase:"),function(self,_225,_226,_227){
with(self){
if(borderRightWidthAdjusted<=0){
return 0;
}
var _228=borderRightWidthAdjusted;
var _229=0;
var _22a=0;
var _22b=_228-((_228+objj_msgSend(self,"borderOverlap"))/2);
if(cornerRadiusTopRightAdjusted>0){
if(cornerRadiusTopRightAdjusted>_228){
CGPathAddArc(_226,NULL,objj_msgSend(self,"width")-cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted-_22b,M_PI+M_PI_2+M_PI_4,0,0);
_229+=(M_PI_4*(cornerRadiusTopRightAdjusted-_22b));
_22a=cornerRadiusTopRightAdjusted;
}else{
CGPathMoveToPoint(_226,NULL,objj_msgSend(self,"width")-_22b,_228);
_22a=_228;
}
}else{
CGPathMoveToPoint(_226,NULL,objj_msgSend(self,"width")-_22b,objj_msgSend(self,"defaultVerticalSquareBorderStart"));
_22a=objj_msgSend(self,"defaultVerticalSquareBorderStart");
}
var _22c=0;
if(cornerRadiusBottomRightAdjusted<=0){
_22c=objj_msgSend(self,"defaultVerticalSquareBorderEnd");
}else{
if(cornerRadiusBottomRightAdjusted<_228){
_22c=objj_msgSend(self,"height")-_228;
}else{
_22c=objj_msgSend(self,"height")-cornerRadiusBottomRightAdjusted;
}
}
CGPathAddLineToPoint(_226,NULL,objj_msgSend(self,"width")-_22b,_22c);
_229+=(_22c-_22a);
var _22d=0;
if(cornerRadiusBottomRightAdjusted>0){
if(cornerRadiusBottomRightAdjusted>_228){
CGPathAddArc(_226,NULL,objj_msgSend(self,"width")-cornerRadiusBottomRightAdjusted,objj_msgSend(self,"height")-cornerRadiusBottomRightAdjusted,cornerRadiusBottomRightAdjusted-_22b,0,M_PI_4,0);
_229+=M_PI_4*(cornerRadiusBottomRightAdjusted-_22b);
_22d=outputPhaseForBorder(objj_msgSend(self,"borderRightType"),_228,_229,_227);
}
}else{
_22d=outputPhaseForBorder(objj_msgSend(self,"borderRightType"),_228,_229,_227);
}
...
}),new objj_method(sel_getUid("addBottomBorderToStrokePath:inputPhase:"),function(self,_22e,_22f,_230){
with(self){
if(borderBottomWidthAdjusted<=0){
return 0;
}
var _231=borderBottomWidthAdjusted;
var _232=0;
var _233=0;
var _234=_231-((_231+objj_msgSend(self,"borderOverlap"))/2);
if(cornerRadiusBottomRightAdjusted>0){
if(cornerRadiusBottomRightAdjusted>_231){
CGPathAddArc(_22f,NULL,objj_msgSend(self,"width")-cornerRadiusBottomRightAdjusted,objj_msgSend(self,"height")-cornerRadiusBottomRightAdjusted,cornerRadiusBottomRightAdjusted-_234,M_PI_4,M_PI_2,0);
_232+=(M_PI_4*(cornerRadiusBottomRightAdjusted-_234));
_233=objj_msgSend(self,"width")-cornerRadiusBottomRightAdjusted;
}else{
CGPathMoveToPoint(_22f,NULL,objj_msgSend(self,"width")-_231,objj_msgSend(self,"height")-_234);
_233=objj_msgSend(self,"width")-_231;
}
}else{
CGPathMoveToPoint(_22f,NULL,objj_msgSend(self,"width"),objj_msgSend(self,"height")-_234);
_233=objj_msgSend(self,"width");
}
var _235=0;
if(cornerRadiusBottomLeftAdjusted<=0){
_235=0;
}else{
if(cornerRadiusBottomLeftAdjusted<_231){
_235=_231;
}else{
_235=cornerRadiusBottomLeftAdjusted;
}
}
CGPathAddLineToPoint(_22f,NULL,_235,objj_msgSend(self,"height")-_234);
_232+=(_233-_235);
var _236=0;
if(cornerRadiusBottomLeftAdjusted>0){
if(cornerRadiusBottomLeftAdjusted>_231){
CGPathAddArc(_22f,NULL,cornerRadiusBottomLeftAdjusted,objj_msgSend(self,"height")-cornerRadiusBottomLeftAdjusted,cornerRadiusBottomLeftAdjusted-_234,M_PI_2,M_PI_2+M_PI_4,0);
_232+=M_PI_4*(cornerRadiusBottomLeftAdjusted-_234);
_236=outputPhaseForBorder(objj_msgSend(self,"borderBottomType"),_231,_232,_230);
}
}else{
_236=outputPhaseForBorder(objj_msgSend(self,"borderBottomType"),_231,_232,_230);
}
...
}),new objj_method(sel_getUid("addLeftBorderToStrokePath:inputPhase:"),function(self,_237,_238,_239){
with(self){
if(borderLeftWidthAdjusted<=0){
return 0;
}
var _23a=borderLeftWidthAdjusted;
var _23b=0;
var _23c=0;
var _23d=_23a-((_23a+objj_msgSend(self,"borderOverlap"))/2);
if(cornerRadiusBottomLeftAdjusted>0){
if(cornerRadiusBottomLeftAdjusted>_23a){
CGPathAddArc(_238,NULL,cornerRadiusBottomLeftAdjusted,objj_msgSend(self,"height")-cornerRadiusBottomLeftAdjusted,cornerRadiusBottomLeftAdjusted-_23d,M_PI_2+M_PI_4,M_PI,0);
_23b+=(M_PI_4*(cornerRadiusBottomLeftAdjusted-_23d));
_23c=objj_msgSend(self,"height")-cornerRadiusBottomLeftAdjusted;
}else{
CGPathMoveToPoint(_238,NULL,_23d,objj_msgSend(self,"height")-_23a);
_23c=objj_msgSend(self,"height")-_23a;
}
}else{
CGPathMoveToPoint(_238,NULL,_23d,objj_msgSend(self,"defaultVerticalSquareBorderEnd"));
_23c=objj_msgSend(self,"height");
}
var _23e=0;
if(cornerRadiusTopLeftAdjusted<=0){
_23e=objj_msgSend(self,"defaultVerticalSquareBorderStart");
}else{
if(cornerRadiusTopLeftAdjusted<_23a){
_23e=_23a;
}else{
_23e=cornerRadiusTopLeftAdjusted;
}
}
CGPathAddLineToPoint(_238,NULL,_23d,_23e);
_23b+=(_23c-_23e);
var _23f=0;
if(cornerRadiusTopLeftAdjusted>0){
if(cornerRadiusTopLeftAdjusted>_23a){
CGPathAddArc(_238,NULL,cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted-_23d,M_PI,M_PI+M_PI_4,0);
_23b+=M_PI_4*(cornerRadiusTopLeftAdjusted-_23d);
_23f=outputPhaseForBorder(objj_msgSend(self,"borderLeftType"),_23a,_23b,_239);
}
}else{
_23f=outputPhaseForBorder(objj_msgSend(self,"borderLeftType"),_23a,_23b,_239);
}
...
}),new objj_method(sel_getUid("drawStrokeBorder"),function(self,_240){
with(self){
var _241=GDGetCurrentContext();
var _242=CGPathCreateMutable();
var _243=0;
var _244=0;
if(borderTopType!=GDBorderTypeSolid){
_243=objj_msgSend(self,"addTopBorderToStrokePath:inputPhase:",_242,0);
...
CGContextSaveGState(_241);
CGContextSetStrokeColorWithAlpha(_241,objj_msgSend(borderTopColor,"colorWithAlphaComponent:",1),objj_msgSend(borderTopColor,"alphaComponent"));
objj_msgSend(self,"drawBorderPath:inContext:borderType:borderWidth:phase:",_242,_241,borderTopType,borderTopWidthAdjusted,_244);
CGContextRestoreGState(_241);
CGPathRelease(_242);
_242=CGPathCreateMutable();
_244=_243;
}
}else{
_244=0;
...
_243=objj_msgSend(self,"addRightBorderToStrokePath:inputPhase:",_242,_244);
...
CGContextSaveGState(_241);
CGContextSetStrokeColorWithAlpha(_241,objj_msgSend(borderRightColor,"colorWithAlphaComponent:",1),objj_msgSend(borderRightColor,"alphaComponent"));
objj_msgSend(self,"drawBorderPath:inContext:borderType:borderWidth:phase:",_242,_241,borderRightType,borderRightWidthAdjusted,_244);
CGContextRestoreGState(_241);
CGPathRelease(_242);
_242=CGPathCreateMutable();
_244=_243;
...
_243=objj_msgSend(self,"addBottomBorderToStrokePath:inputPhase:",_242,_244);
...
CGContextSaveGState(_241);
CGContextSetStrokeColorWithAlpha(_241,objj_msgSend(borderBottomColor,"colorWithAlphaComponent:",1),objj_msgSend(borderBottomColor,"alphaComponent"));
objj_msgSend(self,"drawBorderPath:inContext:borderType:borderWidth:phase:",_242,_241,borderBottomType,borderBottomWidthAdjusted,_244);
CGContextRestoreGState(_241);
CGPathRelease(_242);
_242=CGPathCreateMutable();
_244=_243;
...
objj_msgSend(self,"addLeftBorderToStrokePath:inputPhase:",_242,_244);
CGContextSaveGState(_241);
CGContextSetStrokeColorWithAlpha(_241,objj_msgSend(borderLeftColor,"colorWithAlphaComponent:",1),objj_msgSend(borderLeftColor,"alphaComponent"));
objj_msgSend(self,"drawBorderPath:inContext:borderType:borderWidth:phase:",_242,_241,borderLeftType,borderLeftWidthAdjusted,_244);
CGContextRestoreGState(_241);
}
CGPathRelease(_242);
}
}),new objj_method(sel_getUid("addTopBorderToFillPaths:"),function(self,_245,_246){
with(self){
if(borderTopWidthAdjusted<=0){
return;
}
var _247=objj_msgSend(_246,"objectForKey:",objj_msgSend(borderTopColor,"cssString"));
var _248=borderTopWidthAdjusted;
if(borderTopType==GDBorderTypeSolid){
var _249=0,_24a=objj_msgSend(self,"width");
if(cornerRadiusTopLeftAdjusted>0){
_249=(cornerRadiusTopLeftAdjusted>_248)?cornerRadiusTopLeftAdjusted:_248;
}
if(cornerRadiusTopRightAdjusted>0){
_24a=(cornerRadiusTopRightAdjusted<_248)?objj_msgSend(self,"width")-_248:objj_msgSend(self,"width")-cornerRadiusTopRightAdjusted;
}
var rr=CGRectMake(_249,-objj_msgSend(self,"borderOverlap"),_24a-_249,borderTopWidthAdjusted+objj_msgSend(self,"borderOverlap"));
CGPathAddRect(_247,NULL,rr);
CGPathCloseSubpath(_247);
}
if(cornerRadiusTopLeftAdjusted>0){
if(_248>=cornerRadiusTopLeftAdjusted){
CGPathMoveToPoint(_247,NULL,0,0);
CGPathAddLineToPoint(_247,NULL,_248,_248);
CGPathAddLineToPoint(_247,NULL,_248,0);
CGPathCloseSubpath(_247);
}else{
if(borderTopType==GDBorderTypeSolid&&_248<cornerRadiusTopLeftAdjusted){
CGPathMoveToPoint(_247,NULL,0,0);
CGPathAddArc(_247,NULL,cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted-_248,M_PI+M_PI_4,M_PI+M_PI_2,0);
CGPathAddLineToPoint(_247,NULL,cornerRadiusTopLeftAdjusted,0);
CGPathCloseSubpath(_247);
}
}
}
if(cornerRadiusTopRightAdjusted>0){
if(_248>=cornerRadiusTopRightAdjusted){
CGPathMoveToPoint(_247,NULL,objj_msgSend(self,"width"),0);
CGPathAddLineToPoint(_247,NULL,objj_msgSend(self,"width")-_248,0);
CGPathAddLineToPoint(_247,NULL,objj_msgSend(self,"width")-_248,_248);
CGPathCloseSubpath(_247);
}else{
if(borderTopType==GDBorderTypeSolid&&_248<cornerRadiusTopRightAdjusted){
CGPathMoveToPoint(_247,NULL,objj_msgSend(self,"width")-cornerRadiusTopRightAdjusted,0);
CGPathAddArc(_247,NULL,objj_msgSend(self,"width")-cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted-_248,M_PI+M_PI_2,M_PI+M_PI_2+M_PI_4,0);
CGPathAddLineToPoint(_247,NULL,objj_msgSend(self,"width"),0);
CGPathCloseSubpath(_247);
}
}
}
}
}),new objj_method(sel_getUid("addRightBorderToFillPaths:"),function(self,_24b,_24c){
with(self){
if(borderRightWidthAdjusted<=0){
return;
}
var _24d=objj_msgSend(_24c,"objectForKey:",objj_msgSend(borderRightColor,"cssString"));
var _24e=borderRightWidthAdjusted;
if(borderRightType==GDBorderTypeSolid){
var _24f=objj_msgSend(self,"defaultVerticalSquareBorderStart"),_250=objj_msgSend(self,"defaultVerticalSquareBorderEnd");
if(cornerRadiusTopRightAdjusted>0){
_24f=(cornerRadiusTopRightAdjusted>_24e)?cornerRadiusTopRightAdjusted:_24e;
}
if(cornerRadiusBottomRightAdjusted>0){
_250=(cornerRadiusBottomRightAdjusted<_24e)?objj_msgSend(self,"height")-_24e:objj_msgSend(self,"height")-cornerRadiusBottomRightAdjusted;
}
CGPathAddRect(_24d,NULL,CGRectMake(objj_msgSend(self,"width")-_24e,_24f,_24e+objj_msgSend(self,"borderOverlap"),_250-_24f));
CGPathCloseSubpath(_24d);
}
if(cornerRadiusTopRightAdjusted>0){
if(_24e>=cornerRadiusTopRightAdjusted){
CGPathMoveToPoint(_24d,NULL,objj_msgSend(self,"width"),0);
CGPathAddLineToPoint(_24d,NULL,objj_msgSend(self,"width")-_24e,_24e);
CGPathAddLineToPoint(_24d,NULL,objj_msgSend(self,"width"),_24e);
CGPathCloseSubpath(_24d);
}else{
if(borderRightType==GDBorderTypeSolid&&_24e<cornerRadiusTopRightAdjusted){
CGPathMoveToPoint(_24d,NULL,objj_msgSend(self,"width"),0);
CGPathAddArc(_24d,NULL,objj_msgSend(self,"width")-cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted-_24e,M_PI+M_PI_2+M_PI_4,0,0);
CGPathAddLineToPoint(_24d,NULL,objj_msgSend(self,"width"),cornerRadiusTopRightAdjusted);
CGPathCloseSubpath(_24d);
}
}
}
if(cornerRadiusBottomRightAdjusted>0){
if(_24e>=cornerRadiusBottomRightAdjusted){
CGPathMoveToPoint(_24d,NULL,objj_msgSend(self,"width"),objj_msgSend(self,"height"));
CGPathAddLineToPoint(_24d,NULL,objj_msgSend(self,"width"),objj_msgSend(self,"height")-_24e);
CGPathAddLineToPoint(_24d,NULL,objj_msgSend(self,"width")-_24e,objj_msgSend(self,"height")-_24e);
CGPathCloseSubpath(_24d);
}else{
if(borderRightType==GDBorderTypeSolid&&_24e<cornerRadiusBottomRightAdjusted){
CGPathMoveToPoint(_24d,NULL,objj_msgSend(self,"width"),objj_msgSend(self,"height")-cornerRadiusBottomRightAdjusted);
CGPathAddArc(_24d,NULL,objj_msgSend(self,"width")-cornerRadiusBottomRightAdjusted,objj_msgSend(self,"height")-cornerRadiusBottomRightAdjusted,cornerRadiusBottomRightAdjusted-_24e,0,M_PI_4,0);
CGPathAddLineToPoint(_24d,NULL,objj_msgSend(self,"width"),objj_msgSend(self,"height"));
CGPathCloseSubpath(_24d);
}
}
}
}
}),new objj_method(sel_getUid("addBottomBorderToFillPaths:"),function(self,_251,_252){
with(self){
if(borderBottomWidthAdjusted<=0){
return;
}
var _253=objj_msgSend(_252,"objectForKey:",objj_msgSend(borderBottomColor,"cssString"));
var _254=borderBottomWidthAdjusted;
if(borderBottomType==GDBorderTypeSolid){
var _255=0,_256=objj_msgSend(self,"width");
if(cornerRadiusBottomLeftAdjusted>0){
_255=(cornerRadiusBottomLeftAdjusted>_254)?cornerRadiusBottomLeftAdjusted:_254;
}
if(cornerRadiusBottomRightAdjusted>0){
_256=(cornerRadiusBottomRightAdjusted<_254)?objj_msgSend(self,"width")-_254:objj_msgSend(self,"width")-cornerRadiusBottomRightAdjusted;
}
CGPathAddRect(_253,NULL,CGRectMake(_255,objj_msgSend(self,"height")-_254,_256-_255,_254+objj_msgSend(self,"borderOverlap")));
CGPathCloseSubpath(_253);
}
if(cornerRadiusBottomRightAdjusted>0){
if(_254>=cornerRadiusBottomRightAdjusted){
CGPathMoveToPoint(_253,NULL,objj_msgSend(self,"width"),objj_msgSend(self,"height"));
CGPathAddLineToPoint(_253,NULL,objj_msgSend(self,"width")-_254,objj_msgSend(self,"height")-_254);
CGPathAddLineToPoint(_253,NULL,objj_msgSend(self,"width")-_254,objj_msgSend(self,"height"));
CGPathCloseSubpath(_253);
}else{
if(borderBottomType==GDBorderTypeSolid&&_254<cornerRadiusBottomRightAdjusted){
CGPathMoveToPoint(_253,NULL,objj_msgSend(self,"width"),objj_msgSend(self,"height"));
CGPathAddArc(_253,NULL,objj_msgSend(self,"width")-cornerRadiusBottomRightAdjusted,objj_msgSend(self,"height")-cornerRadiusBottomRightAdjusted,cornerRadiusBottomRightAdjusted-_254,M_PI_4,M_PI_2,0);
CGPathAddLineToPoint(_253,NULL,objj_msgSend(self,"width")-cornerRadiusBottomRightAdjusted,objj_msgSend(self,"height"));
CGPathCloseSubpath(_253);
}
}
}
if(cornerRadiusBottomLeftAdjusted>0){
if(_254>=cornerRadiusBottomLeftAdjusted){
CGPathMoveToPoint(_253,NULL,0,objj_msgSend(self,"height"));
CGPathAddLineToPoint(_253,NULL,_254,objj_msgSend(self,"height")-_254);
CGPathAddLineToPoint(_253,NULL,_254,objj_msgSend(self,"height"));
CGPathCloseSubpath(_253);
}else{
if(borderBottomType==GDBorderTypeSolid&&_254<cornerRadiusBottomLeftAdjusted){
CGPathMoveToPoint(_253,NULL,cornerRadiusBottomLeftAdjusted,objj_msgSend(self,"height"));
CGPathAddArc(_253,NULL,cornerRadiusBottomLeftAdjusted,objj_msgSend(self,"height")-cornerRadiusBottomLeftAdjusted,cornerRadiusBottomLeftAdjusted-_254,M_PI_2,M_PI_2+M_PI_4,0);
CGPathAddLineToPoint(_253,NULL,0,objj_msgSend(self,"height"));
CGPathCloseSubpath(_253);
}
}
}
}
}),new objj_method(sel_getUid("addLeftBorderToFillPaths:"),function(self,_257,_258){
with(self){
if(borderLeftWidthAdjusted<=0){
return;
}
var _259=objj_msgSend(_258,"objectForKey:",objj_msgSend(borderLeftColor,"cssString"));
var _25a=borderLeftWidthAdjusted;
if(borderLeftType==GDBorderTypeSolid){
var _25b=objj_msgSend(self,"defaultVerticalSquareBorderStart"),_25c=objj_msgSend(self,"defaultVerticalSquareBorderEnd");
if(cornerRadiusTopLeftAdjusted>0){
_25b=(cornerRadiusTopLeftAdjusted>_25a)?cornerRadiusTopLeftAdjusted:_25a;
}
if(cornerRadiusBottomLeftAdjusted>0){
_25c=(cornerRadiusBottomLeftAdjusted<_25a)?objj_msgSend(self,"height")-_25a:objj_msgSend(self,"height")-cornerRadiusBottomLeftAdjusted;
}
CGPathAddRect(_259,NULL,CGRectMake(-objj_msgSend(self,"borderOverlap"),_25b,_25a+objj_msgSend(self,"borderOverlap"),_25c-_25b));
CGPathCloseSubpath(_259);
}
if(cornerRadiusBottomLeftAdjusted>0){
if(_25a>=cornerRadiusBottomLeftAdjusted){
CGPathMoveToPoint(_259,NULL,0,objj_msgSend(self,"height"));
CGPathAddLineToPoint(_259,NULL,0,objj_msgSend(self,"height")-_25a);
CGPathAddLineToPoint(_259,NULL,_25a,objj_msgSend(self,"height")-_25a);
CGPathCloseSubpath(_259);
}else{
if(borderLeftType==GDBorderTypeSolid&&_25a<cornerRadiusBottomLeftAdjusted){
CGPathMoveToPoint(_259,NULL,0,objj_msgSend(self,"height"));
CGPathAddArc(_259,NULL,cornerRadiusBottomLeftAdjusted,objj_msgSend(self,"height")-cornerRadiusBottomLeftAdjusted,cornerRadiusBottomLeftAdjusted-_25a,M_PI_2+M_PI_4,M_PI,0);
CGPathAddLineToPoint(_259,NULL,0,objj_msgSend(self,"height")-cornerRadiusBottomLeftAdjusted);
CGPathCloseSubpath(_259);
}
}
}
if(cornerRadiusTopLeftAdjusted>0){
if(_25a>=cornerRadiusTopLeftAdjusted){
CGPathMoveToPoint(_259,NULL,0,0);
CGPathAddLineToPoint(_259,NULL,0,_25a);
CGPathAddLineToPoint(_259,NULL,_25a,_25a);
CGPathCloseSubpath(_259);
}else{
if(borderLeftType==GDBorderTypeSolid&&_25a<cornerRadiusTopLeftAdjusted){
CGPathMoveToPoint(_259,NULL,0,cornerRadiusTopLeftAdjusted);
CGPathAddArc(_259,NULL,cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted-_25a,M_PI,M_PI+M_PI_4,0);
CGPathAddLineToPoint(_259,NULL,0,0);
CGPathCloseSubpath(_259);
}
}
}
}
}),new objj_method(sel_getUid("borderFillPathColors"),function(self,_25d){
with(self){
return objj_msgSend(CPArray,"arrayWithObjects:",borderTopColor,borderRightColor,borderBottomColor,borderLeftColor,nil);
}
}),new objj_method(sel_getUid("prepareBorderFillPaths"),function(self,_25e){
with(self){
var _25f=objj_msgSend(CPMutableDictionary,"dictionary");
var _260=objj_msgSend(self,"borderFillPathColors");
for(var i=0;i<objj_msgSend(_260,"count");i++){
var _261=objj_msgSend(_260,"objectAtIndex:",i);
var path=CGPathCreateMutable();
objj_msgSend(_25f,"setObject:forKey:",path,objj_msgSend(_261,"cssString"));
CGPathRelease(path);
}
return _25f;
}
}),new objj_method(sel_getUid("drawBorderFillPaths:inContext:"),function(self,_262,_263,_264){
with(self){
var _265=objj_msgSend(_263,"allKeys");
for(var i=0;i<objj_msgSend(_265,"count");i++){
var _266=objj_msgSend(_265,"objectAtIndex:",i);
var path=objj_msgSend(_263,"objectForKey:",_266);
if(!CGPathIsEmpty(path)){
CGContextSaveGState(_264);
var _267=objj_msgSend(CPColor,"colorWithCSSString:",_266);
CGContextSetFillColorWithAlpha(_264,objj_msgSend(_267,"colorWithAlphaComponent:",1),objj_msgSend(_267,"alphaComponent"));
CGContextBeginPath(_264);
CGContextAddPath(_264,path);
CGContextFillPath(_264);
CGContextRestoreGState(_264);
}
}
}
}),new objj_method(sel_getUid("drawFillBorder"),function(self,_268){
with(self){
var _269=objj_msgSend(self,"prepareBorderFillPaths");
objj_msgSend(self,"addTopBorderToFillPaths:",_269);
objj_msgSend(self,"addRightBorderToFillPaths:",_269);
objj_msgSend(self,"addBottomBorderToFillPaths:",_269);
objj_msgSend(self,"addLeftBorderToFillPaths:",_269);
objj_msgSend(self,"drawBorderFillPaths:inContext:",_269,GDGetCurrentContext());
}
}),new objj_method(sel_getUid("drawRegularBorder"),function(self,_26a){
with(self){
objj_msgSend(self,"drawFillBorder");
objj_msgSend(self,"drawStrokeBorder");
}
}),new objj_method(sel_getUid("drawGradientBorder"),function(self,_26b){
with(self){
var _26c=GDGetCurrentContext();
var _26d=objj_msgSend(self,"bounds");
_26d.origin=CGPointMake(0,0);
...
objj_msgSend(objj_msgSend(self,"borderGradientFill"),"radialFillRect:",_26d);
}else{
objj_msgSend(objj_msgSend(self,"borderGradientFill"),"fillRect:angle:",_26d,objj_msgSend(self,"borderGradientAngle")+90);
}
}
}),new objj_method(sel_getUid("drawBorder"),function(self,_26e){
with(self){
...
var _270=objj_msgSend(self,"bounds");
_270.origin=NSZeroPoint();
CGContextBeginPath(_26f);
CGContextAddCounterClockwiseRect(_26f,_270);
objj_msgSend(self,"addInnerCellPathToContext:",_26f);
...
}),new objj_method(sel_getUid("createPathInContext:size:"),function(self,_271,_272,size){
with(self){
CGContextBeginPath(_272);
CGContextMoveToPoint(_272,0,cornerRadiusTopLeftAdjusted);
CGContextAddArc(_272,cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted,M_PI,M_PI+M_PI_2,true);
CGContextAddArc(_272,size.width-cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted,M_PI+M_PI_2,0,true);
CGContextAddArc(_272,size.width-cornerRadiusBottomRightAdjusted,size.height-cornerRadiusBottomRightAdjusted,cornerRadiusBottomRightAdjusted,0,M_PI_2,true);
CGContextAddArc(_272,cornerRadiusBottomLeftAdjusted,size.height-cornerRadiusBottomLeftAdjusted,cornerRadiusBottomLeftAdjusted,M_PI_2,M_PI,true);
CGContextClosePath(_272);
}
}),new objj_method(sel_getUid("drawDropShadow"),function(self,_273){
with(self){
if(!dropShadow||(objj_msgSend(self,"width")*objj_msgSend(self,"height")>GDMaximumCellSizeForShadow)){
return;
}
var _274=document.createElement("canvas");
_274.width=objj_msgSend(self,"bounds").size.width+2*GDDropShadowLayerOverlap;
_274.height=objj_msgSend(self,"bounds").size.height+2*GDDropShadowLayerOverlap;
var _275=_274.getContext("2d");
CGContextTranslateCTM(_275,GDDropShadowLayerOverlap,GDDropShadowLayerOverlap);
_275.fillStyle=objj_msgSend(dropShadowColor,"cssString");
CGContextSaveGState(_275);
CGContextSetAntetypeDropShadow(_275,dropShadowOffset,dropShadowAngle,dropShadowOpacity,dropShadowBlur*2,dropShadowColor);
var _276=objj_msgSend(self,"bounds").size;
objj_msgSend(self,"createPathInContext:size:",_275,_276);
CGContextFillPath(_275);
CGContextRestoreGState(_275);
_275.fillStyle=objj_msgSend(dropShadowColor,"cssString");
_275.globalCompositeOperation="destination-out";
objj_msgSend(self,"createPathInContext:size:",_275,_276);
CGContextFillPath(_275);
var _277=GDGetCurrentContext();
CGContextSaveGState(_277);
_277.drawImage(_274,-GDDropShadowLayerOverlap,-GDDropShadowLayerOverlap);
CGContextRestoreGState(_277);
}
}),new objj_method(sel_getUid("drawInnerShadow"),function(self,_278){
with(self){
...
CGContextSetAntetypeInnerShadow(_279,innerShadowOffset,innerShadowAngle,innerShadowOpacity,innerShadowBlur,innerShadowColor);
CGContextSetFillColor(_279,innerShadowColor);
var _27a=fmaxf(fmaxf(fabsf(innerShadowOffset*2),innerShadowBlur*2),50);
var rect=CGRectMake(-_27a,-_27a,objj_msgSend(self,"width")+2*_27a,objj_msgSend(self,"height")+2*_27a);
CGContextBeginPath(_279);
CGContextAddCounterClockwiseRect(_279,rect);
objj_msgSend(self,"addOuterCellPathToContext:",_279);
CGContextClosePath(_279);
CGContextFillPath(_279);
CGContextRestoreGState(_279);
}
}),new objj_method(sel_getUid("drawBackground"),function(self,_27b){
with(self){
var _27c=GDGetCurrentContext();
CGContextSaveGState(_27c);
var _27d=objj_msgSend(self,"bounds");
_27d.origin=NSZeroPoint();
objj_msgSend(objj_msgSend(self,"background"),"paintRect:",_27d);
CGContextRestoreGState(_27c);
}
}),new objj_method(sel_getUid("drawContentInRect:atScale:"),function(self,_27e,rect,_27f){
with(self){
var _280=GDGetCurrentContext();
CGContextSaveGState(_280);
objj_msgSend(objj_msgSend(self,"affineBorderTransform"),"concat");
var _281=CGRectMakeCopy(rect);
var _282=objj_msgSend(self,"affineTransform");
objj_msgSend(_282,"invert");
_281.origin=objj_msgSend(_282,"transformPoint:",_281.origin);
var _283=nil;
var _284=objj_msgSend(self,"drawingEnumerator");
while((_283=objj_msgSend(_284,"nextObject"))!=nil){
objj_msgSend(_283,"drawRect:atScale:",_281,_27f);
}
CGContextRestoreGState(_280);
}
}),new objj_method(sel_getUid("drawText"),function(self,_285){
with(self){
if(objj_msgSend(self,"hasTextContent")){
var _286=GDGetCurrentContext();
CGContextSaveGState(_286);
var _287=objj_msgSend(self,"affineOriginTransform");
objj_msgSend(_287,"invert");
objj_msgSend(_287,"concat");
objj_msgSend(objj_msgSend(self,"textRenderObject"),"draw");
CGContextRestoreGState(_286);
}
}
}),new objj_method(sel_getUid("shouldDrawInRect:"),function(self,_288,rect){
with(self){
...
}),new objj_method(sel_getUid("drawRect:atScale:"),function(self,_289,rect,_28a){
with(self){
...
var _28d=CGRectMakeCopy(rect);
_28d.origin=objj_msgSend(_28c,"transformPoint:",_28d.origin);
CGContextSetAlpha(_28b,objj_msgSend(self,"opacity"));
var _28e=_28b;
...
if(dropShadow){
_28f=GDDropShadowLayerOverlap;
}
}
_28e=CGContextBeginTransparencyLayer(_28b,CGRectMake(-_28f,-_28f,objj_msgSend(self,"width")+2*_28f,objj_msgSend(self,"height")+2*_28f),_28d);
}
objj_msgSend(self,"drawDropShadow");
CGContextSaveGState(_28e);
CGContextBeginPath(_28e);
objj_msgSend(self,"addOuterCellPathToContext:",_28e);
CGContextClosePath(_28e);
CGContextClip(_28e);
CGContextBeginTransparencyLayer(_28e,CGRectMake(0,0,objj_msgSend(self,"width"),objj_msgSend(self,"height")),_28d);
objj_msgSend(self,"drawBackground");
if(objj_msgSend(self,"isContentClipped")){
objj_msgSend(self,"drawContentInRect:atScale:",rect,_28a);
objj_msgSend(self,"drawText");
}
objj_msgSend(self,"drawInnerShadow");
objj_msgSend(self,"drawBorder");
CGContextEndTransparencyLayer(_28e);
CGContextRestoreGState(_28e);
if(!objj_msgSend(self,"isContentClipped")){
objj_msgSend(self,"drawContentInRect:atScale:",rect,_28a);
objj_msgSend(self,"drawText");
}
...
}),new objj_method(sel_getUid("handles"),function(self,_290){
with(self){
return objj_msgSend(CPArray,"array");
}
}),new objj_method(sel_getUid("drawBounds"),function(self,_291){
with(self){
var _292=objj_msgSend(self,"bounds");
if(!objj_msgSend(self,"isContentClipped")){
var _293=objj_msgSend(self,"affineTransform");
var _294=objj_msgSend(objj_msgSend(self,"orderedDisplayComponents"),"objectEnumerator");
var cell=nil;
while((cell=objj_msgSend(_294,"nextObject"))!=nil){
var _295=objj_msgSend(cell,"drawBounds");
_295.origin=objj_msgSend(_293,"transformPoint:",_295.origin);
_292=NSUnionRect(_292,_295);
}
}else{
var _296=nil;
var _294=objj_msgSend(objj_msgSend(self,"orderedDisplayComponents"),"objectEnumerator");
while((_296=objj_msgSend(_294,"nextObject"))!=nil){
var _297=objj_msgSend(self,"absoluteAffineTransform");
objj_msgSend(_297,"invert");
var _298=objj_msgSend(objj_msgSend(_296,"deepDrawingAboveAllComponents"),"objectEnumerator");
var cell=nil;
while((cell=objj_msgSend(_298,"nextObject"))!=nil){
var _295=objj_msgSend(cell,"globalDrawBounds");
_295.origin=objj_msgSend(_297,"transformPoint:",_295.origin);
_292=NSUnionRect(_292,_295);
}
}
}
if(dropShadow){
_292=NSUnionRect(_292,NSInsetRect(objj_msgSend(self,"bounds"),-GDDropShadowLayerOverlap,-GDDropShadowLayerOverlap));
}
return _292;
}
}),new objj_method(sel_getUid("globalDrawBounds"),function(self,_299){
with(self){
var _29a=objj_msgSend(self,"drawBounds");
_29a.origin=objj_msgSend(objj_msgSend(self,"absoluteAffineTransform"),"transformPoint:",_29a.origin);
return _29a;
}
}),new objj_method(sel_getUid("redraw"),function(self,_29b){
with(self){
objj_msgSend(screenChangeManager,"renderObjectNoteUpdateRect:",self);
}
}),new objj_method(sel_getUid("activeLayout"),function(self,_29c){
with(self){
return activeLayout;
}
}),new objj_method(sel_getUid("setActiveLayout:"),function(self,_29d,_29e){
with(self){
if(activeLayout==_29e){
return;
}
...
}),new objj_method(sel_getUid("activeHorizontalAlignment"),function(self,_29f){
with(self){
return activeHorizontalAlignment;
}
}),new objj_method(sel_getUid("setActiveHorizontalAlignment:"),function(self,_2a0,_2a1){
with(self){
if(activeHorizontalAlignment==_2a1){
return;
}
objj_msgSend(self,"willChangeValueForKey:","activeHorizontalAlignment");
activeHorizontalAlignment=_2a1;
objj_msgSend(self,"didChangeValueForKey:","activeHorizontalAlignment");
objj_msgSend(screenChangeManager,"renderObjectNeedsHorizontalContainerLayout:",self);
}
}),new objj_method(sel_getUid("activeVerticalAlignment"),function(self,_2a2){
with(self){
return activeVerticalAlignment;
}
}),new objj_method(sel_getUid("setActiveVerticalAlignment:"),function(self,_2a3,_2a4){
with(self){
if(activeVerticalAlignment==_2a4){
return;
}
objj_msgSend(self,"willChangeValueForKey:","activeVerticalAlignment");
activeVerticalAlignment=_2a4;
objj_msgSend(self,"didChangeValueForKey:","activeVerticalAlignment");
objj_msgSend(screenChangeManager,"renderObjectNeedsVerticalContainerLayout:",self);
}
}),new objj_method(sel_getUid("shiftNonActiveComponentsToX:ignoreFlex:"),function(self,_2a5,theX,_2a6){
with(self){
var _2a7=objj_msgSend(self,"orderedDisplayComponents");
if(objj_msgSend(_2a7,"count")==0){
return 0;
}
var _2a8=1000000;
for(var i=0;i<objj_msgSend(_2a7,"count");i++){
var _2a9=objj_msgSend(_2a7,"objectAtIndex:",i);
if(objj_msgSend(_2a9,"activeLayout")){
continue;
}
if(_2a6&&objj_msgSend(_2a9,"horizontalResizing")==GDFlexResizing){
continue;
}
_2a8=fminf(_2a8,objj_msgSend(_2a9,"fullBounds").origin.x);
}
var _2aa=theX-_2a8;
for(var i=0;i<objj_msgSend(_2a7,"count");i++){
var _2a9=objj_msgSend(_2a7,"objectAtIndex:",i);
...
if(_2a6&&objj_msgSend(_2a9,"horizontalResizing")==GDFlexResizing){
objj_msgSend(_2a9,"setFullX:",theX);
}else{
objj_msgSend(_2a9,"setFullX:",objj_msgSend(_2a9,"fullBounds").origin.x+_2aa);
}
}
return _2aa;
}
}),new objj_method(sel_getUid("shiftNonActiveComponentsToY:ignoreFlex:"),function(self,_2ab,theY,_2ac){
with(self){
var _2ad=objj_msgSend(self,"orderedDisplayComponents");
if(objj_msgSend(_2ad,"count")==0){
return 0;
}
var _2ae=10000000;
for(var i=0;i<objj_msgSend(_2ad,"count");i++){
var _2af=objj_msgSend(_2ad,"objectAtIndex:",i);
if(objj_msgSend(_2af,"activeLayout")){
continue;
}
if(_2ac&&objj_msgSend(_2af,"verticalResizing")==GDFlexResizing){
continue;
}
_2ae=fminf(_2ae,objj_msgSend(_2af,"fullBounds").origin.y);
}
var _2b0=theY-_2ae;
for(var i=0;i<objj_msgSend(_2ad,"count");i++){
var _2af=objj_msgSend(_2ad,"objectAtIndex:",i);
...
if(_2ac&&objj_msgSend(_2af,"verticalResizing")==GDFlexResizing){
objj_msgSend(_2af,"setFullY:",theY);
}else{
objj_msgSend(_2af,"setFullY:",objj_msgSend(_2af,"fullBounds").origin.y+_2b0);
}
}
return _2b0;
}
}),new objj_method(sel_getUid("needsHorizontalLayout"),function(self,_2b1){
with(self){
return needsHorizontalLayout;
}
}),new objj_method(sel_getUid("needsVerticalLayout"),function(self,_2b2){
with(self){
return needsVerticalLayout;
}
}),new objj_method(sel_getUid("needsPassOnVerticalLayout"),function(self,_2b3){
with(self){
return needsPassOnVerticalLayout;
}
}),new objj_method(sel_getUid("needsPassOnHorizontalLayout"),function(self,_2b4){
with(self){
return needsPassOnHorizontalLayout;
}
}),new objj_method(sel_getUid("setNeedsHorizontalCellLayout"),function(self,_2b5){
with(self){
needsHorizontalLayout=YES;
if(objj_msgSend(self,"horizontalResizing")==GDIntrinsicResizing){
...
}),new objj_method(sel_getUid("setNeedsHorizontalContainerLayout"),function(self,_2b6){
with(self){
objj_msgSend(objj_msgSend(self,"container"),"setNeedsHorizontalCellLayout");
}
}),new objj_method(sel_getUid("setNeedsHorizontalLayout"),function(self,_2b7){
with(self){
needsHorizontalLayout=YES;
objj_msgSend(objj_msgSend(self,"container"),"setNeedsHorizontalCellLayout");
}
}),new objj_method(sel_getUid("setNeedsPassOnHorizontalLayout"),function(self,_2b8){
with(self){
needsPassOnHorizontalLayout=YES;
objj_msgSend(objj_msgSend(self,"container"),"setNeedsPassOnHorizontalLayout");
}
}),new objj_method(sel_getUid("setNeedsVerticalCellLayout"),function(self,_2b9){
with(self){
needsVerticalLayout=YES;
if(objj_msgSend(self,"verticalResizing")==GDIntrinsicResizing){
...
}),new objj_method(sel_getUid("setNeedsVerticalContainerLayout"),function(self,_2ba){
with(self){
objj_msgSend(objj_msgSend(self,"container"),"setNeedsVerticalCellLayout");
}
}),new objj_method(sel_getUid("setNeedsVerticalLayout"),function(self,_2bb){
with(self){
needsVerticalLayout=YES;
objj_msgSend(objj_msgSend(self,"container"),"setNeedsVerticalCellLayout");
}
}),new objj_method(sel_getUid("setNeedsPassOnVerticalLayout"),function(self,_2bc){
with(self){
needsPassOnVerticalLayout=YES;
objj_msgSend(objj_msgSend(self,"container"),"setNeedsPassOnVerticalLayout");
}
}),new objj_method(sel_getUid("setNeedsHorizontalLayoutCellOnly:"),function(self,_2bd,_2be){
with(self){
needsHorizontalLayout=_2be;
}
}),new objj_method(sel_getUid("setNeedsVerticalLayoutCellOnly:"),function(self,_2bf,_2c0){
with(self){
needsVerticalLayout=_2c0;
}
}),new objj_method(sel_getUid("horizontalLayoutIfNeeded"),function(self,_2c1){
with(self){
objj_msgSend(self,"layoutIfNeededUsingAdaptor:",objj_msgSend(self,"createHorizontalLayoutAdaptor"));
}
}),new objj_method(sel_getUid("verticalLayoutIfNeeded"),function(self,_2c2){
with(self){
objj_msgSend(self,"layoutIfNeededUsingAdaptor:",objj_msgSend(self,"createVerticalLayoutAdaptor"));
}
}),new objj_method(sel_getUid("layoutIfNeededUsingAdaptor:"),function(self,_2c3,_2c4){
with(self){
if(objj_msgSend(_2c4,"isVertical")){
if(objj_msgSend(self,"needsVerticalLayout")){
objj_msgSend(objj_msgSend(self,"layoutPolicy"),"layoutAdaptor:",_2c4);
}else{
if(objj_msgSend(self,"needsPassOnVerticalLayout")){
objj_msgSend(_2c4,"layoutComponents");
}
}
...
if(objj_msgSend(_2c4,"isHorizontal")){
...
}),new objj_method(sel_getUid("createHorizontalLayoutAdaptor"),function(self,_2c5){
with(self){
return objj_msgSend(GDHorizontalLayoutAdaptor,"adaptorForRenderObject:",self);
}
}),new objj_method(sel_getUid("createVerticalLayoutAdaptor"),function(self,_2c6){
with(self){
return objj_msgSend(GDVerticalLayoutAdaptor,"adaptorForRenderObject:",self);
}
}),new objj_method(sel_getUid("addOuterCellPathToContext:"),function(self,_2c7,_2c8){
with(self){
var _2c9=objj_msgSend(self,"bounds");
_2c9.origin=CGPointMake(0,0);
CGContextMoveToPoint(_2c8,NSMinX(_2c9)+cornerRadiusTopLeftAdjusted,NSMinY(_2c9));
if(cornerRadiusTopRightAdjusted>0){
CGContextAddArc(_2c8,NSMaxX(_2c9)-cornerRadiusTopRightAdjusted,NSMinY(_2c9)+cornerRadiusTopRightAdjusted,cornerRadiusTopRightAdjusted,M_PI+M_PI_2,0,1);
}else{
CGContextAddLineToPoint(_2c8,NSMaxX(_2c9),NSMinY(_2c9));
}
if(cornerRadiusBottomRightAdjusted>0){
CGContextAddArc(_2c8,NSMaxX(_2c9)-cornerRadiusBottomRightAdjusted,NSMaxY(_2c9)-cornerRadiusBottomRightAdjusted,cornerRadiusBottomRightAdjusted,0,M_PI_2,1);
}else{
CGContextAddLineToPoint(_2c8,NSMaxX(_2c9),NSMaxY(_2c9));
}
if(cornerRadiusBottomLeftAdjusted>0){
CGContextAddArc(_2c8,NSMinX(_2c9)+cornerRadiusBottomLeftAdjusted,NSMaxY(_2c9)-cornerRadiusBottomLeftAdjusted,cornerRadiusBottomLeftAdjusted,M_PI_2,M_PI,1);
}else{
CGContextAddLineToPoint(_2c8,NSMinX(_2c9),NSMaxY(_2c9));
}
if(cornerRadiusTopLeftAdjusted>0){
CGContextAddArc(_2c8,NSMinX(_2c9)+cornerRadiusTopLeftAdjusted,NSMinY(_2c9)+cornerRadiusTopLeftAdjusted,cornerRadiusTopLeftAdjusted,M_PI,M_PI+M_PI_2,1);
}else{
CGContextAddLineToPoint(_2c8,NSMinX(_2c9),NSMinY(_2c9));
CGContextAddLineToPoint(_2c8,NSMinX(_2c9)+cornerRadiusTopLeftAdjusted,NSMinY(_2c9));
}
}
}),new objj_method(sel_getUid("addInnerCellPathToContext:"),function(self,_2ca,_2cb){
with(self){
var top=objj_msgSend(self,"borderTopWidthAdjusted");
var _2cc=objj_msgSend(self,"borderRightWidthAdjusted");
var _2cd=objj_msgSend(self,"borderBottomWidthAdjusted");
var left=objj_msgSend(self,"borderLeftWidthAdjusted");
var _2ce=objj_msgSend(self,"cornerRadiusTopLeftAdjusted");
var _2cf=objj_msgSend(self,"cornerRadiusBottomLeftAdjusted");
var _2d0=objj_msgSend(self,"cornerRadiusTopRightAdjusted");
var _2d1=objj_msgSend(self,"cornerRadiusBottomRightAdjusted");
var _2d2;
if(_2ce<=0){
CGContextMoveToPoint(_2cb,left,top);
_2d2=CGPointMake(left,top);
}else{
if(left>_2ce){
CGContextMoveToPoint(_2cb,left,left);
_2d2=CGPointMake(left,left);
}else{
CGContextAddArc(_2cb,_2ce,_2ce,_2ce-left,M_PI,M_PI+M_PI_4,1);
_2d2=CGPointMake(left,_2ce);
}
if(top>_2ce){
CGContextAddLineToPoint(_2cb,top,top);
}else{
CGContextAddArc(_2cb,_2ce,_2ce,_2ce-top,M_PI+M_PI_4,M_PI+M_PI_2,1);
}
}
if(_2d0<=0){
CGContextAddLineToPoint(_2cb,objj_msgSend(self,"width")-_2cc,top);
}else{
if(top>_2d0){
CGContextAddLineToPoint(_2cb,objj_msgSend(self,"width")-top,top);
}else{
CGContextAddArc(_2cb,objj_msgSend(self,"width")-_2d0,_2d0,_2d0-top,M_PI+M_PI_2,M_PI+M_PI_2+M_PI_4,1);
}
if(_2cc>_2d0){
CGContextAddLineToPoint(_2cb,objj_msgSend(self,"width")-_2cc,_2cc);
}else{
CGContextAddArc(_2cb,objj_msgSend(self,"width")-_2d0,_2d0,_2d0-_2cc,M_PI+M_PI_2+M_PI_4,0,1);
}
}
if(_2d1<=0){
CGContextAddLineToPoint(_2cb,objj_msgSend(self,"width")-_2cc,objj_msgSend(self,"height")-_2cd);
}else{
if(_2cc>_2d1){
CGContextAddLineToPoint(_2cb,objj_msgSend(self,"width")-_2cc,objj_msgSend(self,"height")-_2cc);
}else{
CGContextAddArc(_2cb,objj_msgSend(self,"width")-_2d1,objj_msgSend(self,"height")-_2d1,_2d1-_2cc,0,M_PI_4,1);
}
if(_2cd>_2d1){
CGContextAddLineToPoint(_2cb,objj_msgSend(self,"width")-_2cd,objj_msgSend(self,"height")-_2cd);
}else{
CGContextAddArc(_2cb,objj_msgSend(self,"width")-_2d1,objj_msgSend(self,"height")-_2d1,_2d1-_2cd,M_PI_4,M_PI_2,1);
}
}
if(_2cf<=0){
CGContextAddLineToPoint(_2cb,left,objj_msgSend(self,"height")-_2cd);
}else{
if(_2cd>_2cf){
CGContextAddLineToPoint(_2cb,_2cd,objj_msgSend(self,"height")-_2cd);
}else{
CGContextAddArc(_2cb,_2cf,objj_msgSend(self,"height")-_2cf,_2cf-_2cd,M_PI_2,M_PI_2+M_PI_4,1);
}
if(left>_2cf){
CGContextAddLineToPoint(_2cb,left,objj_msgSend(self,"height")-left);
}else{
CGContextAddArc(_2cb,_2cf,objj_msgSend(self,"height")-_2cf,_2cf-left,M_PI_2+M_PI_4,M_PI,1);
}
}
CGContextAddLineToPoint(_2cb,_2d2.x,_2d2.y);
}
})]);
class_addMethods(_7,[new objj_method(sel_getUid("keyPathsForValuesAffectingTextAttributedString"),function(self,_2d3){
with(self){
return objj_msgSend(CPSet,"setWithObject:","textStringValue");
}
}),new objj_method(sel_getUid("keyPathsForValuesAffectingTextStringValue"),function(self,_2d4){
with(self){
...
p;16;GDEventManager.jt;7456;@STATIC;1.0;I;23;Foundation/Foundation.jI;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;10;GDAction.ji;22;GDWidgetInstanceCell.ji;26;GDWidgetInstanceRootCell.ji;16;GDEventHandler.jt;7267;
objj_executeFile("Foundation/Foundation.j",NO);
objj_executeFile("Foundation/Foundation.j",NO);
objj_executeFile("AppKit/AppKit.j",NO);
objj_executeFile("GDAction.j",YES);
...
p;16;GDRenderObject.jt;13909;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;19;GDAffineTransform.ji;19;GDCompositeFigure.ji;16;GDLayoutPolicy.ji;19;GDLayoutConstants.jt;13748;
objj_executeFile("Foundation/Foundation.j",NO);
objj_executeFile("AppKit/AppKit.j",NO);
...
}),new objj_method(sel_getUid("deepVisibleComponentsDo:"),function(_bc,_bd,_be){
with(_bc){
if(visibility==GDVisibilityVisible){
_be(_bc);
}
...
class_addMethods(_2,[new objj_method(sel_getUid("keyPathsForValuesAffectingValueForKey:"),function(_bf,_c0,key){
with(_bf){
...
return objj_msgSendSuper({receiver:_bf,super_class:objj_getMetaClass("GDRenderObject").super_class},"keyPathsForValuesAffectingValueForKey:",key);
}
}),new objj_method(sel_getUid("automaticallyNotifiesObserversForKey:"),function(_c1,_c2,key){
with(_c1){
return NO;
}
}),new objj_method(sel_getUid("renderObjectForFigure:screenChangeManager:"),function(_c3,_c4,_c5,_c6){
with(_c3){
return objj_msgSend(objj_msgSend(objj_msgSend(_c3,"alloc"),"initWithFigure:screenChangeManager:",_c5,_c6),"autorelease");
}
}),new objj_method(sel_getUid("renderObjectWithBounds:figure:screenChangeManager:"),function(_c7,_c8,r,_c9,_ca){
with(_c7){
var _cb=objj_msgSend(_c7,"renderObjectForFigure:screenChangeManager:",_c9,_ca);
objj_msgSend(_cb,"setBounds:",r);
return _cb;
}
})]);
...
p;11;GDRunTool.jt;5771;@STATIC;1.0;I;23;Foundation/Foundation.jI;15;AppKit/AppKit.ji;8;GDTool.ji;9;GDEvent.ji;11;GDProject.ji;16;GDEventManager.jt;5642;
objj_executeFile("Foundation/Foundation.j",NO);
objj_executeFile("AppKit/AppKit.j",NO);
objj_executeFile("GDTool.j",YES);
objj_executeFile("GDEvent.j",YES);
...
p;23;GDScreenChangeManager.jt;13643;@STATIC;1.0;I;21;Foundation/CPObject.ji;16;GDRenderObject.ji;20;GDCellRenderObject.ji;26;GDCircleCellRenderObject.ji;28;GDTriangleCellRenderObject.ji;21;GDTableRenderObject.ji;22;GDScreenRenderObject.ji;10;GDCanvas.ji;10;GDScreen.ji;22;GDCocoaCompatibility.ji;23;GDPropertyBindingCore.jt;13349;
objj_executeFile("Foundation/CPObject.j",NO);
objj_executeFile("GDRenderObject.j",YES);
objj_executeFile("GDCellRenderObject.j",YES);
...
}),new objj_method(sel_getUid("screen"),function(_24,_25){
with(_24){
return screen;
}
}),new objj_method(sel_getUid("windowSizeChanged"),function(_26,_27){
with(_26){
if(view==nil){
return;
}
var _28=objj_msgSend(screenRenderObject,"bounds").size;
var _29=_28;
if(objj_msgSend(view,"enclosingScrollView")){
_29=objj_msgSend(objj_msgSend(view,"enclosingScrollView"),"contentSize");
}
var _2a=CGSizeMake(MAX(_28.width,_29.width),MAX(_28.height,_29.height));
...
_2a.height=_29.height;
}
objj_msgSend(ueberRenderObject,"setBounds:",CGRectMake(0,0,_2a.width,_2a.height));
objj_msgSend(view,"setFrame:",objj_msgSend(ueberRenderObject,"bounds"));
}
}),new objj_method(sel_getUid("visitCompositeFigure:"),function(_2b,_2c,_2d){
with(_2b){
}
}),new objj_method(sel_getUid("visitWidgetInstanceCell:"),function(_2e,_2f,_30){
with(_2e){
var _31;
if(objj_msgSend(_30,"isTableCell")||objj_msgSend(_30,"isTableRow")){
return;
}else{
if(objj_msgSend(_30,"isTable")){
_31=objj_msgSend(GDTableRenderObject,"renderObjectForFigure:screenChangeManager:",_30,_2e);
}else{
if(objj_msgSend(_30,"cellType")==GDCircleCellType){
_31=objj_msgSend(GDCircleCellRenderObject,"renderObjectForFigure:screenChangeManager:",_30,_2e);
}else{
if(objj_msgSend(_30,"cellType")==GDTriangleCellType){
_31=objj_msgSend(GDTriangleCellRenderObject,"renderObjectForFigure:screenChangeManager:",_30,_2e);
}else{
_31=objj_msgSend(GDCellRenderObject,"renderObjectForFigure:screenChangeManager:",_30,_2e);
}
}
}
}
var _32=objj_msgSend(_30,"container");
var _33=objj_msgSend(_2e,"renderObjectForFigure:",_32);
var _34=objj_msgSend(objj_msgSend(_32,"orderedComponents"),"indexOfObject:",_30);
objj_msgSend(_33,"insertComponent:atIndex:",_31,_34);
}
}),new objj_method(sel_getUid("renderObjectShouldDraw:"),function(_35,_36,_37){
with(_35){
var _38=objj_msgSend(objj_msgSend(_37,"figure"),"isSpecificationCell");
var _39=showSpecificationCells();
if(_38&&!_39){
return NO;
}
var _3a=objj_msgSend(_37,"isDeepDrawingAboveAll");
return (drawingAboveAllMode&&_3a)||(!drawingAboveAllMode&&!_3a);
}
}),new objj_method(sel_getUid("drawAboveAllInRect:atScale:"),function(_3b,_3c,_3d,_3e){
with(_3b){
var _3f=GDGetCurrentContext();
var _40=nil;
var _41=objj_msgSend(objj_msgSend(screenRenderObject,"deepOrderedDrawingAboveAllComponents"),"objectEnumerator");
while((_40=objj_msgSend(_41,"nextObject"))!=nil){
CGContextSaveGState(_3f);
var _42=objj_msgSend(_40,"absoluteAffineTransform");
objj_msgSend(_42,"concat");
objj_msgSend(_42,"invert");
var _43=CGRectMakeCopy(_3d);
_43.origin=objj_msgSend(_42,"transformPoint:",_43.origin);
objj_msgSend(_40,"drawRect:atScale:",_43,_3e);
CGContextRestoreGState(_3f);
}
}
}),new objj_method(sel_getUid("drawRect:"),function(_44,_45,_46){
with(_44){
var _47=objj_msgSend(objj_msgSend(CPGraphicsContext,"currentContext"),"graphicsPort");
setupTransparencyLayerFeature(_47);
updateGlobalCurrentContext();
var _48=CGSizeMake(1,1);
_46.size.width=fminf(10000,_46.size.width);
_46.size.height=fminf(10000,_46.size.height);
CGContextSaveGState(_47);
CGContextAddRect(_47,_46);
CGContextClip(_47);
objj_msgSend(ueberRenderObject,"drawRect:atScale:",_46,_48);
drawingAboveAllMode=YES;
objj_msgSend(_44,"drawAboveAllInRect:atScale:",_46,_48);
drawingAboveAllMode=NO;
var _49=nil;
var _4a=objj_msgSend(handles,"objectEnumerator");
while((_49=objj_msgSend(_4a,"nextObject"))!=nil){
objj_msgSend(_49,"drawRect:atScale:",_46,_48);
}
CGContextRestoreGState(_47);
}
}),new objj_method(sel_getUid("handleAtPoint:"),function(_4b,_4c,p){
with(_4b){
for(var i=0;i<handles.length;i++){
var _4d=handles[i];
if(objj_msgSend(_4d,"handleAtPoint:",p)!=nil){
return _4d;
}
}
return nil;
}
}),new objj_method(sel_getUid("renderObjectAtPoint:"),function(_4e,_4f,p){
with(_4e){
return objj_msgSend(screenRenderObject,"renderAtPoint:",p);
}
}),new objj_method(sel_getUid("allRenderObjectsAtPoint:"),function(_50,_51,p){
with(_50){
return objj_msgSend(screenRenderObject,"allRenderObjectsAtPoint:",p);
}
}),new objj_method(sel_getUid("renderObjectForFigure:"),function(_52,_53,_54){
with(_52){
return figureRenderObjectDictionary[_54];
}
}),new objj_method(sel_getUid("updateRenderObjectForWidgetInstance:loadValuesForState:"),function(_55,_56,_57,_58){
with(_55){
var _59=objj_msgSend(_57,"rootInstanceCell");
var _5a=objj_msgSend(_55,"renderObjectForFigure:",_59);
if(objj_msgSend(_5a,"currentState")==_58){
return;
}
objj_msgSend(_55,"startWork");
objj_msgSend(_5a,"updateValuesToState:",_58);
objj_msgSend(_55,"stopWork");
}
}),new objj_method(sel_getUid("renderObjectNoteUpdateRect:"),function(_5b,_5c,_5d){
with(_5b){
if(partialRedrawDisabled){
return;
}
var r=objj_msgSend(_5d,"globalDrawBounds");
if(isWorking){
objj_msgSend(_5b,"addUpdateRect:",r);
}else{
objj_msgSend(view,"noteUpdateRect:",r);
}
}
}),new objj_method(sel_getUid("addUpdateRect:"),function(_5e,_5f,r){
with(_5e){
objj_msgSend(updateRects,"addObject:",r);
}
}),new objj_method(sel_getUid("unionOfUpdateRects"),function(_60,_61){
with(_60){
if(objj_msgSend(updateRects,"isEmpty")){
return CGRectMake(0,0,0,0);
}
var _62=objj_msgSend(updateRects,"firstObject");
var _63=nil;
var _64=objj_msgSend(updateRects,"objectEnumerator");
while((_63=objj_msgSend(_64,"nextObject"))!=nil){
_62=CGRectUnion(_62,_63);
}
return _62;
}
}),new objj_method(sel_getUid("deliverUpdateRects"),function(_65,_66){
with(_65){
var _67=objj_msgSend(_65,"unionOfUpdateRects");
objj_msgSend(updateRects,"removeAllObjects");
if(NSEqualRects(_67,NSZeroRect())){
return;
}
objj_msgSend(view,"noteUpdateRect:",_67);
}
}),new objj_method(sel_getUid("startWork"),function(_68,_69){
with(_68){
isWorking++;
}
}),new objj_method(sel_getUid("stopWorkAndLayout:redraw:"),function(_6a,_6b,_6c,_6d){
with(_6a){
if(isWorking-1<=0){
if(_6c){
objj_msgSend(_6a,"layout");
}
if(_6d){
objj_msgSend(_6a,"deliverUpdateRects");
}
}
isWorking--;
if(isWorking<0){
...
}),new objj_method(sel_getUid("stopWork"),function(_6e,_6f){
with(_6e){
objj_msgSend(_6e,"stopWorkAndLayout:redraw:",YES,YES);
}
}),new objj_method(sel_getUid("layout"),function(_70,_71){
with(_70){
if(layoutingDisabled==0){
objj_msgSend(_70,"disableLayouting");
objj_msgSend(ueberRenderObject,"horizontalLayoutIfNeeded");
objj_msgSend(ueberRenderObject,"verticalLayoutIfNeeded");
objj_msgSend(objj_msgSend(GDPropertyBindingManager,"sharedInstance"),"updateAllBoundRenderObjects:",_70);
objj_msgSend(ueberRenderObject,"horizontalLayoutIfNeeded");
objj_msgSend(ueberRenderObject,"verticalLayoutIfNeeded");
objj_msgSend(_70,"enableLayouting");
}
}
}),new objj_method(sel_getUid("disableLayouting"),function(_72,_73){
with(_72){
layoutingDisabled++;
}
}),new objj_method(sel_getUid("enableLayouting"),function(_74,_75){
with(_74){
layoutingDisabled--;
if(layoutingDisabled<0){
layoutingDisabled=0;
...
}),new objj_method(sel_getUid("triggerLayout"),function(_76,_77){
with(_76){
if(!isWorking){
objj_msgSend(_76,"startWork");
objj_msgSend(_76,"stopWorkAndLayout:redraw:",YES,NO);
}
}
}),new objj_method(sel_getUid("renderObjectNeedsHorizontalLayout:"),function(_78,_79,_7a){
with(_78){
objj_msgSend(_7a,"setNeedsHorizontalLayout");
objj_msgSend(_78,"triggerLayout");
}
}),new objj_method(sel_getUid("renderObjectNeedsHorizontalCellLayout:"),function(_7b,_7c,_7d){
with(_7b){
objj_msgSend(_7d,"setNeedsHorizontalCellLayout");
objj_msgSend(_7b,"triggerLayout");
}
}),new objj_method(sel_getUid("renderObjectNeedsHorizontalContainerLayout:"),function(_7e,_7f,_80){
with(_7e){
objj_msgSend(_80,"setNeedsHorizontalContainerLayout");
objj_msgSend(_7e,"triggerLayout");
}
}),new objj_method(sel_getUid("renderObjectNeedsVerticalLayout:"),function(_81,_82,_83){
with(_81){
objj_msgSend(_83,"setNeedsVerticalLayout");
objj_msgSend(_81,"triggerLayout");
}
}),new objj_method(sel_getUid("renderObjectNeedsVerticalCellLayout:"),function(_84,_85,_86){
with(_84){
objj_msgSend(_86,"setNeedsVerticalCellLayout");
objj_msgSend(_84,"triggerLayout");
}
}),new objj_method(sel_getUid("renderObjectNeedsVerticalContainerLayout:"),function(_87,_88,_89){
with(_87){
objj_msgSend(_89,"setNeedsVerticalContainerLayout");
objj_msgSend(_87,"triggerLayout");
}
})]);
